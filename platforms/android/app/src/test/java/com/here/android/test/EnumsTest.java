...
public class EnumsTest {
    ...
    public void flipEnumTC() {
        ...
        assertEquals(InternalErrorTypeCollection.ERROR_NONE,
    ...
    public void extractEnumFromStructTC() {
        ...
        assertEquals(InternalErrorTypeCollection.ERROR_FATAL,
    ...
    public void createStructWithEnumInside() {
        ...
        Enums.ErrorStruct result = Enums
                .createStructWithEnumInside(Enums.InternalError.ERROR_FATAL, message);
    ...
    public void createStructWithEnumInsideTC() {
        String message = "myMessage";
        ErrorStructTypeCollection result = EnumsTypeCollectionMethods
                .createStructWithEnumInside(InternalErrorTypeCollection.ERROR_FATAL, message);
