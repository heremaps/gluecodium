...
language (e.g. C++, Java, Kotlin, Swift, Dart). "IDL" is an industry-standard abbreviation for "Interface
...
* Description: declares a constructor (Java, Kotlin, Swift, Dart) or a factory function (C++) in the parent type:
...
such transitions is the same for Java, Kotlin, Swift, and Dart. For simplification, these are collectively called "Platform
