...
public class EquatableFragment extends Fragment {
    ...
    private final static String STRUCT_OUTPUT_FORMAT = "EquatableStruct {\n" +
            "    intField = %d\n" +
            "    stringField = \"%s\"\n" +
    ...
    private final EquatableStruct referenceStruct = new EquatableStruct(42, "Foo",
            new NestedEquatableStruct("Bar"));
    ...
    public View onCreateView(
        ...
        referenceStructLabel.setText(String.format(Locale.getDefault(), STRUCT_OUTPUT_FORMAT,
                referenceStruct.intField,
                referenceStruct.stringField,
                referenceStruct.structField.stringField));

        TextView referenceHashcodeLabel = rootView.findViewById(R.id.equatable_reference_hashcode_label);
        referenceHashcodeLabel.setText(getString(R.string.equatable_hashcode_label,
                referenceStruct.hashCode()));
        ...
        processButton.setOnClickListener(
                (View v) -> {
                    ...
                    EquatableStruct newStruct = new EquatableStruct(intValue, stringValue,
                            new NestedEquatableStruct(nestedStringValue));

                    TextView newStructLabel = rootView.findViewById(R.id.equatable_new_struct);
                    newStructLabel.setText(String.format(Locale.getDefault(), STRUCT_OUTPUT_FORMAT,
                            newStruct.intField,
                    ...
                    equalsLabel.setText(getString(R.string.equatable_equals_label,
                            newStruct.equals(referenceStruct)));

                    TextView hashCodeLabel = rootView.findViewById(R.id.equatable_hashcode_label);
                    hashCodeLabel.setText(getString(R.string.equatable_hashcode_label,
                            newStruct.hashCode()));
                });
