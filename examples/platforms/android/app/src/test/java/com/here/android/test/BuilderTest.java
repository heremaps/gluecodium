...
public final class BuilderTest {
    ...
    public void oneMandatoryOneOptionalField() {
        OneMandatoryOneOptional struct = new OneMandatoryOneOptional.Builder().setMandatory(true).build();
    ...
    public void twoMandatoryFields() {
        TwoMandatoryFields struct = new TwoMandatoryFields.Builder().setMandatory(9).setAlsoMandatory("Foo").build();
    ...
    public void twoOptionalTwoMandatory() {
        TwoMandatoryTwoOptional struct = new TwoMandatoryTwoOptional.Builder()
                .setMandatory(false)
                .setAlsoMandatory(9)
                .setAlsoOptional(7)
                .setOptional(true)
    ...
    public void manyMandatoryAndOptionalFields() {
        ManyMandatorAndOptionalFields struct = new ManyMandatorAndOptionalFields.Builder()
                .setMandatory(9)
                .setAlsoMandatory(8)
                .setMoreMandatory(7)
