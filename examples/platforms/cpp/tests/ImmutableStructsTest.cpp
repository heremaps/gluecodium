...
{
    test::PlainDataStructures::ImmutableStructWithCppAccessors some_struct{"foo"};
    test::PlainDataStructures::ImmutableStructWithCppAccessors another_struct(some_struct);
...
{
    test::PlainDataStructures::ImmutableStructWithCppAccessors some_struct{"foo"};
    test::PlainDataStructures::ImmutableStructWithCppAccessors another_struct{""};
