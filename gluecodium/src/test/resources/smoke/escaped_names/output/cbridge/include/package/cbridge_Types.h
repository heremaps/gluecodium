...
#include <stdint.h>
_GLUECODIUM_C_EXPORT _baseRef package_Types_create_handle();
_GLUECODIUM_C_EXPORT void package_Types_release_handle(_baseRef handle);
_GLUECODIUM_C_EXPORT _baseRef package_Types_create_optional_handle();
_GLUECODIUM_C_EXPORT _baseRef package_Types_unwrap_optional_handle(_baseRef handle);
_GLUECODIUM_C_EXPORT void package_Types_release_optional_handle(_baseRef handle);
