...
_GLUECODIUM_C_EXPORT _baseRef package_Types_Struct_create_handle(package_Types_Enum null);
_GLUECODIUM_C_EXPORT void package_Types_Struct_release_handle(_baseRef handle);
_GLUECODIUM_C_EXPORT _baseRef package_Types_Struct_create_optional_handle(package_Types_Enum null);
...
_GLUECODIUM_C_EXPORT package_Types_Enum package_Types_Struct_null_get(_baseRef handle);
#ifdef __cplusplus
}
#endif
