...
JNIEXPORT ::gluecodium::optional<::package::Types::Struct> convert_from_jni(JNIEnv* _jenv, const JniReference<jobject>& _jinput, TypeId<::gluecodium::optional<::package::Types::Struct>>);
