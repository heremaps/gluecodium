...
public:
    smoke_ErrorsInterface_Proxy(uint64_t token, int32_t isolate_id, Dart_Handle dart_handle, FfiOpaqueHandle f0, FfiOpaqueHandle f1, FfiOpaqueHandle f2, FfiOpaqueHandle f3, FfiOpaqueHandle f4)
        : token(token), isolate_id(isolate_id), dart_persistent_handle(Dart_NewPersistentHandle_DL(dart_handle)), f0(f0), f1(f1), f2(f2), f3(f3), f4(f4) {
    ...
    method_with_errors() override {
        ...
        bool _error_flag;
        dispatch([&]() { _error_flag = (*reinterpret_cast<bool (*)(Dart_Handle, uint32_t*)>(f0))(Dart_HandleFromPersistent_DL(dart_persistent_handle),
            &_error_handle
        ); });
    ...
    method_with_external_errors() override {
        uint32_t _error_handle;
        bool _error_flag;
        dispatch([&]() { _error_flag = (*reinterpret_cast<bool (*)(Dart_Handle, uint32_t*)>(f1))(Dart_HandleFromPersistent_DL(dart_persistent_handle),
            &_error_handle
        ); });
    ...
    method_with_errors_and_return_value() override {
        ...
        uint32_t _error_handle;
        bool _error_flag;
        dispatch([&]() { _error_flag = (*reinterpret_cast<bool (*)(Dart_Handle, FfiOpaqueHandle*, uint32_t*)>(f2))(Dart_HandleFromPersistent_DL(dart_persistent_handle),
            &_result_handle,
            &_error_handle
        ); });
        if (_error_flag) {
    ...
    method_with_payload_error() override {
        ...
        bool _error_flag;
        dispatch([&]() { _error_flag = (*reinterpret_cast<bool (*)(Dart_Handle, FfiOpaqueHandle*)>(f3))(Dart_HandleFromPersistent_DL(dart_persistent_handle),
            &_error_handle
        ); });
    ...
    method_with_payload_error_and_return_value() override {
        ...
        FfiOpaqueHandle _error_handle;
        bool _error_flag;
        dispatch([&]() { _error_flag = (*reinterpret_cast<bool (*)(Dart_Handle, FfiOpaqueHandle*, FfiOpaqueHandle*)>(f4))(Dart_HandleFromPersistent_DL(dart_persistent_handle),
            &_result_handle,
            &_error_handle
        ); });
        if (_error_flag) {
...
FfiOpaqueHandle
library_smoke_ErrorsInterface_create_proxy(uint64_t token, int32_t isolate_id, Dart_Handle dart_handle, FfiOpaqueHandle f0, FfiOpaqueHandle f1, FfiOpaqueHandle f2, FfiOpaqueHandle f3, FfiOpaqueHandle f4) {
    ...
    if (cached_proxy) {
        ...
        proxy_ptr = new (std::nothrow) std::shared_ptr<smoke_ErrorsInterface_Proxy>(
            new (std::nothrow) smoke_ErrorsInterface_Proxy(token, isolate_id, dart_handle, f0, f1, f2, f3, f4)
        );
