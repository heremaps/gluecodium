...
namespace jni
{
class com_example_smoke_ErrorsInterface_CppProxy : public CppProxyBase, public ::smoke::ErrorsInterface {
public:
    com_example_smoke_ErrorsInterface_CppProxy( JNIEnv* _jenv, JniReference<jobject> globalRef, jint _jHashCode );
