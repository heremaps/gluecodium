...
struct _GLUECODIUM_CPP_EXPORT EquatableStruct {
    ...
    EquatableStruct( );
    EquatableStruct( bool bool_field, int32_t int_field, int64_t long_field, float float_field, double double_field, ::std::string string_field, ::smoke::NestedEquatableStruct struct_field, ::smoke::SomeEnum enum_field, ::std::vector< ::std::string > array_field, ::smoke::ErrorCodeToMessageMap map_field );
