...
final _smoke_EquatableInterface_register_finalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
EquatableInterface smoke_EquatableInterface_fromFfi(Pointer<Void> handle) {
  ...
  __lib.cacheInstance(_copied_handle, result, _smoke_EquatableInterface_register_finalizer);
  return result;
}
