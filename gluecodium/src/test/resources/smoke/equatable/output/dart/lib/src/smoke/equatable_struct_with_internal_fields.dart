...
class EquatableStructWithInternalFields {
  ...
  EquatableStructWithInternalFields._(this.publicField, this._internalField, this._internalListField, this._internalMapField, this._internalSetField);
  @override
...
EquatableStructWithInternalFields smokeEquatablestructwithinternalfieldsFromFfi(Pointer<Void> handle) {
  ...
  try {
    return EquatableStructWithInternalFields._(
