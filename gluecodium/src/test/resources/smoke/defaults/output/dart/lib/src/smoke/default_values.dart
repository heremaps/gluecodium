...
final _smoke_DefaultValues_register_finalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
DefaultValues smoke_DefaultValues_fromFfi(Pointer<Void> handle) {
  ...
  __lib.cacheInstance(_copied_handle, result, _smoke_DefaultValues_register_finalizer);
  return result;
}
