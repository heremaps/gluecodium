...
struct _GLUECODIUM_CPP_EXPORT StructWithInitializerDefaults {
    ...
    StructWithInitializerDefaults( ::std::vector< int32_t > ints_field, ::smoke::DefaultValues::FloatArray floats_field, ::smoke::DefaultValues::StringSet set_type_field, ::smoke::DefaultValues::IdToStringMap map_field );
};
}
