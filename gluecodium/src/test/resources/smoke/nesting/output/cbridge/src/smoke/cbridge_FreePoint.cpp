...
{
    auto _struct = new ( ::std::nothrow ) std::optional<::smoke::FreePoint>( ::smoke::FreePoint( ) );
    (*_struct)->x = x;
    (*_struct)->y = y;
    return reinterpret_cast<_baseRef>( _struct );
}
...
{
    return reinterpret_cast<_baseRef>( &**reinterpret_cast<std::optional<::smoke::FreePoint>*>( handle ) );
}
void smoke_FreePoint_release_optional_handle(_baseRef handle) {
    delete reinterpret_cast<std::optional<::smoke::FreePoint>*>( handle );
}
