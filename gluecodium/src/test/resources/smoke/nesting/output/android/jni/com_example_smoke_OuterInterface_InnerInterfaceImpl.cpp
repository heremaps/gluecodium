...
#include "com_example_smoke_OuterInterface_InnerInterface__Conversion.h"
...

{
    ...
    auto pInstanceSharedPointer = reinterpret_cast<std::shared_ptr<::smoke::OuterInterface::InnerInterface>*> (
