...
namespace jni
{
class com_example_smoke_Lambdas_00024Producer_CppProxy : public CppProxyBase {
public:
    com_example_smoke_Lambdas_00024Producer_CppProxy( JNIEnv* _jenv, JniReference<jobject> globalRef, jint _jHashCode );
