...
_GLUECODIUM_FFI_EXPORT FfiOpaqueHandle library_smoke_Lambdas_Producer_get_value_nullable(FfiOpaqueHandle handle);
_GLUECODIUM_FFI_EXPORT void library_smoke_Lambdas_Confuser_register_finalizer(FfiOpaqueHandle ffi_handle, int32_t isolate_id, Dart_Handle dart_handle);
...
_GLUECODIUM_FFI_EXPORT FfiOpaqueHandle library_smoke_Lambdas_Confuser_get_value_nullable(FfiOpaqueHandle handle);
_GLUECODIUM_FFI_EXPORT void library_smoke_Lambdas_Consumer_register_finalizer(FfiOpaqueHandle ffi_handle, int32_t isolate_id, Dart_Handle dart_handle);
...
_GLUECODIUM_FFI_EXPORT FfiOpaqueHandle library_smoke_Lambdas_Consumer_get_value_nullable(FfiOpaqueHandle handle);
_GLUECODIUM_FFI_EXPORT void library_smoke_Lambdas_Indexer_register_finalizer(FfiOpaqueHandle ffi_handle, int32_t isolate_id, Dart_Handle dart_handle);
...
_GLUECODIUM_FFI_EXPORT FfiOpaqueHandle library_smoke_Lambdas_Indexer_get_value_nullable(FfiOpaqueHandle handle);
_GLUECODIUM_FFI_EXPORT void library_smoke_Lambdas_NullableConfuser_register_finalizer(FfiOpaqueHandle ffi_handle, int32_t isolate_id, Dart_Handle dart_handle);
...
_GLUECODIUM_FFI_EXPORT FfiOpaqueHandle library_smoke_Lambdas_Producer_create_proxy(uint64_t token, int32_t isolate_id, Dart_Handle dart_handle, FfiOpaqueHandle close_callbacks, FfiOpaqueHandle f0);
_GLUECODIUM_FFI_EXPORT FfiOpaqueHandle library_smoke_Lambdas_Confuser_create_proxy(uint64_t token, int32_t isolate_id, Dart_Handle dart_handle, FfiOpaqueHandle close_callbacks, FfiOpaqueHandle f0);
_GLUECODIUM_FFI_EXPORT FfiOpaqueHandle library_smoke_Lambdas_Consumer_create_proxy(uint64_t token, int32_t isolate_id, Dart_Handle dart_handle, FfiOpaqueHandle close_callbacks, FfiOpaqueHandle f0);
_GLUECODIUM_FFI_EXPORT FfiOpaqueHandle library_smoke_Lambdas_Indexer_create_proxy(uint64_t token, int32_t isolate_id, Dart_Handle dart_handle, FfiOpaqueHandle close_callbacks, FfiOpaqueHandle f0);
_GLUECODIUM_FFI_EXPORT FfiOpaqueHandle library_smoke_Lambdas_NullableConfuser_create_proxy(uint64_t token, int32_t isolate_id, Dart_Handle dart_handle, FfiOpaqueHandle close_callbacks, FfiOpaqueHandle f0);
