...
public:
    ...
    virtual void async_void_throws( std::function<void(bool, ::smoke::AsyncErrorCode)> _completer_callback, const bool input ) = 0;
    ...
    virtual void async_int_throws( std::function<void(bool, int32_t, ::smoke::AsyncErrorCode)> _completer_callback, const bool input ) = 0;
