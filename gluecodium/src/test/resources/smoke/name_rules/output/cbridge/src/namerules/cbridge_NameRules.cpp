...
void namerules_NameRules_intProperty_set(_baseRef _instance, uint32_t value) {
...
void namerules_NameRules_booleanProperty_set(_baseRef _instance, bool value) {
...
void namerules_NameRules_structProperty_set(_baseRef _instance, _baseRef value) {
