...
final _smoke_BasicTypes_register_finalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
BasicTypes smoke_BasicTypes_fromFfi(Pointer<Void> handle) {
  ...
  __lib.cacheInstance(_copied_handle, result, _smoke_BasicTypes_register_finalizer);
  return result;
}
