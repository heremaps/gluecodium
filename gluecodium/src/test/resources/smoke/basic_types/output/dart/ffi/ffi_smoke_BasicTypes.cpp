...
#endif
FfiOpaqueHandle
library_smoke_BasicTypes_stringFunction__String(FfiOpaqueHandle input) {
...
bool
library_smoke_BasicTypes_boolFunction__Boolean(bool input) {
...
float
library_smoke_BasicTypes_floatFunction__Float(float input) {
...
double
library_smoke_BasicTypes_doubleFunction__Double(double input) {
...
int8_t
library_smoke_BasicTypes_byteFunction__Byte(int8_t input) {
...
int16_t
library_smoke_BasicTypes_shortFunction__Short(int16_t input) {
...
int32_t
library_smoke_BasicTypes_intFunction__Int(int32_t input) {
...
int64_t
library_smoke_BasicTypes_longFunction__Long(int64_t input) {
...
uint8_t
library_smoke_BasicTypes_ubyteFunction__UByte(uint8_t input) {
...
uint16_t
library_smoke_BasicTypes_ushortFunction__UShort(uint16_t input) {
...
uint32_t
library_smoke_BasicTypes_uintFunction__UInt(uint32_t input) {
...
uint64_t
library_smoke_BasicTypes_ulongFunction__ULong(uint64_t input) {
