...
class BasicTypes {
  ...
  static bool boolFunction(bool input) {
    final _boolFunction_ffi = __lib.nativeLibrary.lookupFunction<Uint8 Function(Uint8), int Function(int)>('library_smoke_BasicTypes_boolFunction__Boolean');
  ...
  static double floatFunction(double input) {
    final _floatFunction_ffi = __lib.nativeLibrary.lookupFunction<Float Function(Float), double Function(double)>('library_smoke_BasicTypes_floatFunction__Float');
  ...
  static double doubleFunction(double input) {
    final _doubleFunction_ffi = __lib.nativeLibrary.lookupFunction<Double Function(Double), double Function(double)>('library_smoke_BasicTypes_doubleFunction__Double');
    final _input_handle = (input);
  ...
  static int byteFunction(int input) {
    final _byteFunction_ffi = __lib.nativeLibrary.lookupFunction<Int8 Function(Int8), int Function(int)>('library_smoke_BasicTypes_byteFunction__Byte');
    final _input_handle = (input);
  ...
  static int shortFunction(int input) {
    final _shortFunction_ffi = __lib.nativeLibrary.lookupFunction<Int16 Function(Int16), int Function(int)>('library_smoke_BasicTypes_shortFunction__Short');
    final _input_handle = (input);
  ...
  static int intFunction(int input) {
    final _intFunction_ffi = __lib.nativeLibrary.lookupFunction<Int32 Function(Int32), int Function(int)>('library_smoke_BasicTypes_intFunction__Int');
    final _input_handle = (input);
  ...
  static int longFunction(int input) {
    final _longFunction_ffi = __lib.nativeLibrary.lookupFunction<Int64 Function(Int64), int Function(int)>('library_smoke_BasicTypes_longFunction__Long');
    final _input_handle = (input);
  ...
  static int ubyteFunction(int input) {
    final _ubyteFunction_ffi = __lib.nativeLibrary.lookupFunction<Uint8 Function(Uint8), int Function(int)>('library_smoke_BasicTypes_ubyteFunction__UByte');
    final _input_handle = (input);
  ...
  static int ushortFunction(int input) {
    final _ushortFunction_ffi = __lib.nativeLibrary.lookupFunction<Uint16 Function(Uint16), int Function(int)>('library_smoke_BasicTypes_ushortFunction__UShort');
    final _input_handle = (input);
  ...
  static int uintFunction(int input) {
    final _uintFunction_ffi = __lib.nativeLibrary.lookupFunction<Uint32 Function(Uint32), int Function(int)>('library_smoke_BasicTypes_uintFunction__UInt');
    final _input_handle = (input);
  ...
  static int ulongFunction(int input) {
    final _ulongFunction_ffi = __lib.nativeLibrary.lookupFunction<Uint64 Function(Uint64), int Function(int)>('library_smoke_BasicTypes_ulongFunction__ULong');
    final _input_handle = (input);
