...
class BasicTypes {
  static String stringFunction(String input) {
    ...
    final _result_handle = _stringFunction_ffi(_input_handle);
    final _result = __lib.String_fromFfi(_result_handle);
    __lib.String_releaseFfiHandle(_result_handle);
  ...
  static bool boolFunction(bool input) {
    ...
    final _result_handle = _boolFunction_ffi(_input_handle);
    final _result = __lib.Boolean_fromFfi(_result_handle);
    __lib.Boolean_releaseFfiHandle(_result_handle);
  ...
  static double floatFunction(double input) {
    ...
    final _result_handle = _floatFunction_ffi(_input_handle);
    final _result = (_result_handle);
    (_result_handle);
    (_input_handle);
    return _result;
  }
  static double doubleFunction(double input) {
    ...
    final _input_handle = (input);
    final _result_handle = _doubleFunction_ffi(_input_handle);
    final _result = (_result_handle);
    (_result_handle);
    (_input_handle);
    return _result;
  ...
  static int byteFunction(int input) {
    ...
    final _input_handle = (input);
    final _result_handle = _byteFunction_ffi(_input_handle);
    final _result = (_result_handle);
    (_result_handle);
    (_input_handle);
    return _result;
  ...
  static int shortFunction(int input) {
    ...
    final _input_handle = (input);
    final _result_handle = _shortFunction_ffi(_input_handle);
    final _result = (_result_handle);
    (_result_handle);
    (_input_handle);
    return _result;
  ...
  static int intFunction(int input) {
    ...
    final _input_handle = (input);
    final _result_handle = _intFunction_ffi(_input_handle);
    final _result = (_result_handle);
    (_result_handle);
    (_input_handle);
    return _result;
  ...
  static int longFunction(int input) {
    ...
    final _input_handle = (input);
    final _result_handle = _longFunction_ffi(_input_handle);
    final _result = (_result_handle);
    (_result_handle);
    (_input_handle);
    return _result;
  ...
  static int ubyteFunction(int input) {
    ...
    final _input_handle = (input);
    final _result_handle = _ubyteFunction_ffi(_input_handle);
    final _result = (_result_handle);
    (_result_handle);
    (_input_handle);
    return _result;
  ...
  static int ushortFunction(int input) {
    ...
    final _input_handle = (input);
    final _result_handle = _ushortFunction_ffi(_input_handle);
    final _result = (_result_handle);
    (_result_handle);
    (_input_handle);
    return _result;
  ...
  static int uintFunction(int input) {
    ...
    final _input_handle = (input);
    final _result_handle = _uintFunction_ffi(_input_handle);
    final _result = (_result_handle);
    (_result_handle);
    (_input_handle);
    return _result;
  ...
  static int ulongFunction(int input) {
    ...
    final _input_handle = (input);
    final _result_handle = _ulongFunction_ffi(_input_handle);
    final _result = (_result_handle);
    (_result_handle);
    (_input_handle);
    return _result;
