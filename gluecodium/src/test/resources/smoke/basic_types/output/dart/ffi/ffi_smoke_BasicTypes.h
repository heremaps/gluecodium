...
_GLUECODIUM_FFI_EXPORT FfiOpaqueHandle smoke_BasicTypes_copy_handle(FfiOpaqueHandle handle);
_GLUECODIUM_FFI_EXPORT void smoke_BasicTypes_release_handle(FfiOpaqueHandle handle);
#ifdef __cplusplus
}
#endif
