...
final _smoke_GenericTypesWithGenericTypes_register_finalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
GenericTypesWithGenericTypes smoke_GenericTypesWithGenericTypes_fromFfi(Pointer<Void> handle) {
  ...
  __lib.cacheInstance(_copied_handle, result, _smoke_GenericTypesWithGenericTypes_register_finalizer);
  return result;
}
