...
{
    auto _struct = new ( ::std::nothrow ) std::optional<::smoke::GenericTypesWithBasicTypes::StructWithGenerics>( ::smoke::GenericTypesWithBasicTypes::StructWithGenerics( ) );
    (*_struct)->numbers_list = Conversion<::std::vector< uint8_t >>::toCpp( numbersList );
    (*_struct)->numbers_map = Conversion<::std::unordered_map< uint8_t, ::std::string >>::toCpp( numbersMap );
    (*_struct)->numbers_set = Conversion<::std::unordered_set< uint8_t >>::toCpp( numbersSet );
    return reinterpret_cast<_baseRef>( _struct );
...
{
    return reinterpret_cast<_baseRef>( &**reinterpret_cast<std::optional<::smoke::GenericTypesWithBasicTypes::StructWithGenerics>*>( handle ) );
}
void smoke_GenericTypesWithBasicTypes_StructWithGenerics_release_optional_handle(_baseRef handle) {
    delete reinterpret_cast<std::optional<::smoke::GenericTypesWithBasicTypes::StructWithGenerics>*>( handle );
}
