...
FfiOpaqueHandle
library_smoke_Structs_YetAnotherExternalStruct_create_handle(FfiOpaqueHandle stringField) {
...
void
library_smoke_Structs_YetAnotherExternalStruct_release_handle(FfiOpaqueHandle handle) {
    delete reinterpret_cast<::smoke::Structs::Yet_Another_External_Struct*>(handle);
}
FfiOpaqueHandle
library_smoke_Structs_YetAnotherExternalStruct_get_field_stringField(FfiOpaqueHandle handle) {
    return gluecodium::ffi::Conversion<std::string>::toFfi(
        reinterpret_cast<::smoke::Structs::Yet_Another_External_Struct*>(handle)->string_Field
    );
}
FfiOpaqueHandle
library_smoke_Structs_YetAnotherExternalStruct_create_handle_nullable(FfiOpaqueHandle value)
{
    return reinterpret_cast<FfiOpaqueHandle>(
...
void
library_smoke_Structs_YetAnotherExternalStruct_release_handle_nullable(FfiOpaqueHandle handle)
{
    delete reinterpret_cast<gluecodium::optional<::smoke::Structs::Yet_Another_External_Struct>*>(handle);
}
FfiOpaqueHandle
library_smoke_Structs_YetAnotherExternalStruct_get_value_nullable(FfiOpaqueHandle handle)
{
    return gluecodium::ffi::Conversion<::smoke::Structs::Yet_Another_External_Struct>::toFfi(
