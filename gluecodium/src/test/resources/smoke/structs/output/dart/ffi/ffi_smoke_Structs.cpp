...
FfiOpaqueHandle
library_smoke_Structs_ImmutableStructWithCppAccessors_create_handle(int32_t trivialIntField, double trivialDoubleField, FfiOpaqueHandle nontrivialStringField, FfiOpaqueHandle nontrivialPointField, FfiOpaqueHandle nontrivialOptionalPoint) {
    auto _result = new (std::nothrow) smoke::Structs::ImmutableStructWithCppAccessors(gluecodium::ffi::Conversion<int32_t>::toCpp(trivialIntField), gluecodium::ffi::Conversion<double>::toCpp(trivialDoubleField), gluecodium::ffi::Conversion<std::string>::toCpp(nontrivialStringField), gluecodium::ffi::Conversion<smoke::Structs::Point>::toCpp(nontrivialPointField), gluecodium::ffi::Conversion<gluecodium::optional<smoke::Structs::Point>>::toCpp(nontrivialOptionalPoint));
    return reinterpret_cast<FfiOpaqueHandle>(_result);
}
...
int32_t
library_smoke_Structs_ImmutableStructWithCppAccessors_get_field_trivialIntField(FfiOpaqueHandle handle) {
    return gluecodium::ffi::Conversion<int32_t>::toFfi(
        reinterpret_cast<smoke::Structs::ImmutableStructWithCppAccessors*>(handle)->get_trivial_int_field()
    );
}


double
library_smoke_Structs_ImmutableStructWithCppAccessors_get_field_trivialDoubleField(FfiOpaqueHandle handle) {
    return gluecodium::ffi::Conversion<double>::toFfi(
        reinterpret_cast<smoke::Structs::ImmutableStructWithCppAccessors*>(handle)->get_trivial_double_field()
    );
}


FfiOpaqueHandle
library_smoke_Structs_ImmutableStructWithCppAccessors_get_field_nontrivialStringField(FfiOpaqueHandle handle) {
    return gluecodium::ffi::Conversion<std::string>::toFfi(
        reinterpret_cast<smoke::Structs::ImmutableStructWithCppAccessors*>(handle)->get_nontrivial_string_field()
    );
}


FfiOpaqueHandle
library_smoke_Structs_ImmutableStructWithCppAccessors_get_field_nontrivialPointField(FfiOpaqueHandle handle) {
    return gluecodium::ffi::Conversion<smoke::Structs::Point>::toFfi(
        reinterpret_cast<smoke::Structs::ImmutableStructWithCppAccessors*>(handle)->get_nontrivial_point_field()
    );
}


FfiOpaqueHandle
library_smoke_Structs_ImmutableStructWithCppAccessors_get_field_nontrivialOptionalPoint(FfiOpaqueHandle handle) {
    return gluecodium::ffi::Conversion<gluecodium::optional<smoke::Structs::Point>>::toFfi(
        reinterpret_cast<smoke::Structs::ImmutableStructWithCppAccessors*>(handle)->get_nontrivial_optional_point()
    );
}
...
FfiOpaqueHandle
library_smoke_Structs_MutableStructWithCppAccessors_create_handle(int32_t trivialIntField, double trivialDoubleField, FfiOpaqueHandle nontrivialStringField, FfiOpaqueHandle nontrivialPointField, FfiOpaqueHandle nontrivialOptionalPoint) {
    auto _result = new (std::nothrow) smoke::Structs::MutableStructWithCppAccessors();


    _result->set_trivial_int_field(gluecodium::ffi::Conversion<int32_t>::toCpp(trivialIntField));



    _result->set_trivial_double_field(gluecodium::ffi::Conversion<double>::toCpp(trivialDoubleField));



    _result->set_nontrivial_string_field(gluecodium::ffi::Conversion<std::string>::toCpp(nontrivialStringField));



    _result->set_nontrivial_point_field(gluecodium::ffi::Conversion<smoke::Structs::Point>::toCpp(nontrivialPointField));



    _result->set_nontrivial_optional_point(gluecodium::ffi::Conversion<gluecodium::optional<smoke::Structs::Point>>::toCpp(nontrivialOptionalPoint));
...
int32_t
library_smoke_Structs_MutableStructWithCppAccessors_get_field_trivialIntField(FfiOpaqueHandle handle) {
    return gluecodium::ffi::Conversion<int32_t>::toFfi(
        reinterpret_cast<smoke::Structs::MutableStructWithCppAccessors*>(handle)->get_trivial_int_field()
    );
}


double
library_smoke_Structs_MutableStructWithCppAccessors_get_field_trivialDoubleField(FfiOpaqueHandle handle) {
    return gluecodium::ffi::Conversion<double>::toFfi(
        reinterpret_cast<smoke::Structs::MutableStructWithCppAccessors*>(handle)->get_trivial_double_field()
    );
}


FfiOpaqueHandle
library_smoke_Structs_MutableStructWithCppAccessors_get_field_nontrivialStringField(FfiOpaqueHandle handle) {
    return gluecodium::ffi::Conversion<std::string>::toFfi(
        reinterpret_cast<smoke::Structs::MutableStructWithCppAccessors*>(handle)->get_nontrivial_string_field()
    );
}


FfiOpaqueHandle
library_smoke_Structs_MutableStructWithCppAccessors_get_field_nontrivialPointField(FfiOpaqueHandle handle) {
    return gluecodium::ffi::Conversion<smoke::Structs::Point>::toFfi(
        reinterpret_cast<smoke::Structs::MutableStructWithCppAccessors*>(handle)->get_nontrivial_point_field()
    );
}


FfiOpaqueHandle
library_smoke_Structs_MutableStructWithCppAccessors_get_field_nontrivialOptionalPoint(FfiOpaqueHandle handle) {
    return gluecodium::ffi::Conversion<gluecodium::optional<smoke::Structs::Point>>::toFfi(
        reinterpret_cast<smoke::Structs::MutableStructWithCppAccessors*>(handle)->get_nontrivial_optional_point()
    );
}
