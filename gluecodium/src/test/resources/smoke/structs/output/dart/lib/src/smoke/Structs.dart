...
class Structs {
  ...
  static Structs_Point swapPointCoordinates(Structs_Point input) {
    ...
    final _input_handle = smoke_Structs_1Point_toFfi(input);
    final __result_handle = _swapPointCoordinates_ffi(_input_handle);
    final _result = smoke_Structs_1Point_fromFfi(__result_handle);
    smoke_Structs_1Point_releaseFfiHandle(__result_handle);
    smoke_Structs_1Point_releaseFfiHandle(_input_handle);
    return _result;
  }
  static Structs_AllTypesStruct returnAllTypesStruct(Structs_AllTypesStruct input) {
    ...
    final _input_handle = smoke_Structs_1AllTypesStruct_toFfi(input);
    final __result_handle = _returnAllTypesStruct_ffi(_input_handle);
    final _result = smoke_Structs_1AllTypesStruct_fromFfi(__result_handle);
    smoke_Structs_1AllTypesStruct_releaseFfiHandle(__result_handle);
    smoke_Structs_1AllTypesStruct_releaseFfiHandle(_input_handle);
    return _result;
  }
  static Structs_ExternalStruct getExternalStruct() {
    ...
    final _result = smoke_Structs_1ExternalStruct_fromFfi(__result_handle);
    smoke_Structs_1ExternalStruct_releaseFfiHandle(__result_handle);
    return _result;
  }
  static Structs_AnotherExternalStruct getAnotherExternalStruct() {
    ...
    final _result = smoke_Structs_1AnotherExternalStruct_fromFfi(__result_handle);
    smoke_Structs_1AnotherExternalStruct_releaseFfiHandle(__result_handle);
    return _result;
  }
  static Structs_YetAnotherExternalStruct getYetAnotherExternalStruct() {
    ...
    final _result = smoke_Structs_1YetAnotherExternalStruct_fromFfi(__result_handle);
