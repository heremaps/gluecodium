...
import 'package:library/src/smoke/Structs_AllTypesStruct__conversion.dart' as __lib;
import 'package:library/src/smoke/Structs_AnotherExternalStruct__conversion.dart' as __lib;
import 'package:library/src/smoke/Structs_ExternalStruct__conversion.dart' as __lib;
import 'package:library/src/smoke/Structs_Point__conversion.dart' as __lib;
import 'package:library/src/smoke/Structs_YetAnotherExternalStruct__conversion.dart' as __lib;
import 'package:library/src/smoke/TypeCollection.dart';
import 'package:library/src/smoke/TypeCollection_AllTypesStruct__conversion.dart' as __lib;
import 'package:library/src/smoke/TypeCollection_Point__conversion.dart' as __lib;
class Structs {
  static Structs_Point swapPointCoordinates(Structs_Point input) {
    ...
    final _input_handle = __lib.smoke_Structs_Point_toFfi(input);
    final __result_handle = _swapPointCoordinates_ffi(_input_handle);
    final _result = __lib.smoke_Structs_Point_fromFfi(__result_handle);
    __lib.smoke_Structs_Point_releaseFfiHandle(__result_handle);
    __lib.smoke_Structs_Point_releaseFfiHandle(_input_handle);
    return _result;
  }
  static Structs_AllTypesStruct returnAllTypesStruct(Structs_AllTypesStruct input) {
    ...
    final _input_handle = __lib.smoke_Structs_AllTypesStruct_toFfi(input);
    final __result_handle = _returnAllTypesStruct_ffi(_input_handle);
    final _result = __lib.smoke_Structs_AllTypesStruct_fromFfi(__result_handle);
    __lib.smoke_Structs_AllTypesStruct_releaseFfiHandle(__result_handle);
    __lib.smoke_Structs_AllTypesStruct_releaseFfiHandle(_input_handle);
    return _result;
  }
  static Structs_ExternalStruct getExternalStruct() {
    ...
    final _result = __lib.smoke_Structs_ExternalStruct_fromFfi(__result_handle);
    __lib.smoke_Structs_ExternalStruct_releaseFfiHandle(__result_handle);
    return _result;
  }
  static Structs_AnotherExternalStruct getAnotherExternalStruct() {
    ...
    final _result = __lib.smoke_Structs_AnotherExternalStruct_fromFfi(__result_handle);
    __lib.smoke_Structs_AnotherExternalStruct_releaseFfiHandle(__result_handle);
    return _result;
  }
  static Structs_YetAnotherExternalStruct getYetAnotherExternalStruct() {
    ...
    final _result = __lib.smoke_Structs_YetAnotherExternalStruct_fromFfi(__result_handle);
    __lib.smoke_Structs_YetAnotherExternalStruct_releaseFfiHandle(__result_handle);
    return _result;
  }
  static TypeCollection_Point createPoint(double x, double y) {
    ...
    final _result = __lib.smoke_TypeCollection_Point_fromFfi(__result_handle);
    __lib.smoke_TypeCollection_Point_releaseFfiHandle(__result_handle);
    (_x_handle);
    (_y_handle);
    return _result;
  }
  static TypeCollection_AllTypesStruct modifyAllTypesStruct(TypeCollection_AllTypesStruct input) {
    ...
    final _input_handle = __lib.smoke_TypeCollection_AllTypesStruct_toFfi(input);
    final __result_handle = _modifyAllTypesStruct_ffi(_input_handle);
    final _result = __lib.smoke_TypeCollection_AllTypesStruct_fromFfi(__result_handle);
    __lib.smoke_TypeCollection_AllTypesStruct_releaseFfiHandle(__result_handle);
    __lib.smoke_TypeCollection_AllTypesStruct_releaseFfiHandle(_input_handle);
    return _result;
  }
}
class Structs_Point {
