...
{
    return reinterpret_cast<FfiOpaqueHandle>(
        new (std::nothrow) ::gluecodium::optional<smoke::ExternalClass::ErrorEnum>(
...
{
    delete reinterpret_cast<::gluecodium::optional<smoke::ExternalClass::ErrorEnum>*>(handle);
}
...
{
    return gluecodium::ffi::Conversion<smoke::ExternalClass::ErrorEnum>::toFfi(
        **reinterpret_cast<::gluecodium::optional<smoke::ExternalClass::ErrorEnum>*>(handle)
    );
}
