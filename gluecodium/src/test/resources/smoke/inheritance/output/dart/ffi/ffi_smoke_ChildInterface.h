...
_GLUECODIUM_FFI_EXPORT FfiOpaqueHandle library_smoke_ChildInterface_create_proxy(uint64_t token, FfiOpaqueHandle f0, FfiOpaqueHandle f1, FfiOpaqueHandle p0g, FfiOpaqueHandle p0s);
