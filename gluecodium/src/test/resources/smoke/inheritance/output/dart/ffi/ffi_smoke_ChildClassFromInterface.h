...
_GLUECODIUM_FFI_EXPORT void library_smoke_ChildClassFromInterface_register_finalizer(FfiOpaqueHandle ffi_handle, int32_t isolate_id, Dart_Handle dart_handle);
