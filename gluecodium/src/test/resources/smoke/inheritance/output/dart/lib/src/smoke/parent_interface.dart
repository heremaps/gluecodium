...
final _smoke_ParentInterface_register_finalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
ParentInterface smoke_ParentInterface_fromFfi(Pointer<Void> handle) {
  ...
  __lib.cacheInstance(_copied_handle, result, _smoke_ParentInterface_register_finalizer);
  return result;
}
