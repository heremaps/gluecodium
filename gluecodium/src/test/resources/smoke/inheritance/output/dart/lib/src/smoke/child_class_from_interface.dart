...
final _smoke_ChildClassFromInterface_register_finalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
ChildClassFromInterface smoke_ChildClassFromInterface_fromFfi(Pointer<Void> handle) {
  ...
  __lib.cacheInstance(_copied_handle, result, _smoke_ChildClassFromInterface_register_finalizer);
  return result;
}
