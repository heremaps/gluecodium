...
final _smoke_PublicClass_register_finalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
PublicClass smoke_PublicClass_fromFfi(Pointer<Void> handle) {
  ...
  __lib.cacheInstance(_copied_handle, result, _smoke_PublicClass_register_finalizer);
  return result;
}
