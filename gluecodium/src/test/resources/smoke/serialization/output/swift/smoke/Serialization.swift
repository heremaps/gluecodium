...
public struct SerializableStruct: Codable {
    ...
    internal init(cHandle: _baseRef) {
        ...
        arrayField = moveFromCType(smoke_Serialization_SerializableStruct_arrayField_get(cHandle))
        structArrayField = moveFromCType(smoke_Serialization_SerializableStruct_structArrayField_get(cHandle))
        mapField = moveFromCType(smoke_Serialization_SerializableStruct_mapField_get(cHandle))
        setField = moveFromCType(smoke_Serialization_SerializableStruct_setField_get(cHandle))
        enumSetField = moveFromCType(smoke_Serialization_SerializableStruct_enumSetField_get(cHandle))
...
internal func copyToCType(_ swiftType: SerializableStruct) -> RefHolder {
    ...
    let c_structArrayField = moveToCType(swiftType.structArrayField)
    let c_mapField = moveToCType(swiftType.mapField)
    let c_setField = moveToCType(swiftType.setField)
    let c_enumSetField = moveToCType(swiftType.enumSetField)
