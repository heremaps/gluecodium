...
public final class Serialization {
    ...
    public static final class SerializableStruct implements Parcelable {
        ...
        @NonNull
        public Serialization.NestedSerializableStruct structField;
        @NonNull
        public byte[] byteBufferField;
        @NonNull
        public List<String> arrayField;
        @NonNull
        public List<Serialization.NestedSerializableStruct> structArrayField;
        @NonNull
        ...
        private SerializableStruct(final Parcel in_parcel) {
            ...
            java.util.ArrayList<Serialization.SomeEnum> __enumSetField = new java.util.ArrayList<>();
