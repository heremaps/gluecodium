...
{
    auto _struct = new ( ::std::nothrow ) ::gluecodium::optional<::root::space::smoke::BasicTypes::SomeStruct>( ::root::space::smoke::BasicTypes::SomeStruct( ) );
    (*_struct)->some_field = Conversion<::std::string>::toCpp( someField );
    return reinterpret_cast<_baseRef>( _struct );
}
_baseRef
...
{
    return reinterpret_cast<_baseRef>( &**reinterpret_cast<::gluecodium::optional<::root::space::smoke::BasicTypes::SomeStruct>*>( handle ) );
}
void smoke_BasicTypes_SomeStruct_release_optional_handle(_baseRef handle) {
    delete reinterpret_cast<::gluecodium::optional<::root::space::smoke::BasicTypes::SomeStruct>*>( handle );
}
