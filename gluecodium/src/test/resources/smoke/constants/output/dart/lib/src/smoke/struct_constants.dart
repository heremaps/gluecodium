...
final _smoke_StructConstants_register_finalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
StructConstants smoke_StructConstants_fromFfi(Pointer<Void> handle) {
  ...
  __lib.cacheInstance(_copied_handle, result, _smoke_StructConstants_register_finalizer);
  return result;
}
