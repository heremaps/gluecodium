...
JNIEXPORT void JNICALL
Java_com_example_smoke_ChildClassFromInterfaceOverloads_foo__D(JNIEnv* _jenv, jobject _jinstance, jdouble jinput);
JNIEXPORT void JNICALL
...
JNIEXPORT void JNICALL
Java_com_example_smoke_ChildClassFromInterfaceOverloads_bar__D(JNIEnv* _jenv, jobject _jinstance, jdouble jinput);
