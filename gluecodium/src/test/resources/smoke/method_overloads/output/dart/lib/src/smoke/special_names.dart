...
final _smoke_SpecialNames_register_finalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
SpecialNames smoke_SpecialNames_fromFfi(Pointer<Void> handle) {
  ...
  __lib.cacheInstance(_copied_handle, result, _smoke_SpecialNames_register_finalizer);
  return result;
}
