...
_GLUECODIUM_C_EXPORT void smoke_ChildClassFromInterfaceOverloads_foo_Double(_baseRef _instance, double input);

_GLUECODIUM_C_EXPORT void smoke_ChildClassFromInterfaceOverloads_bar_String(_baseRef _instance, _baseRef input);

_GLUECODIUM_C_EXPORT void smoke_ChildClassFromInterfaceOverloads_bar_Double(_baseRef _instance, double input);
