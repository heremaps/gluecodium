...
_baseRef smoke_Nullable_methodWithString(_baseRef _instance, _baseRef input) {
    return Conversion<std::optional< ::std::string >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->method_with_string(Conversion<std::optional< ::std::string >>::toCpp(input)));
}
_baseRef smoke_Nullable_methodWithBoolean(_baseRef _instance, _baseRef input) {
    return Conversion<std::optional< bool >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->method_with_boolean(Conversion<std::optional< bool >>::toCpp(input)));
}
_baseRef smoke_Nullable_methodWithDouble(_baseRef _instance, _baseRef input) {
    return Conversion<std::optional< double >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->method_with_double(Conversion<std::optional< double >>::toCpp(input)));
}
_baseRef smoke_Nullable_methodWithInt(_baseRef _instance, _baseRef input) {
    return Conversion<std::optional< int64_t >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->method_with_int(Conversion<std::optional< int64_t >>::toCpp(input)));
}
_baseRef smoke_Nullable_methodWithSomeStruct(_baseRef _instance, _baseRef input) {
    return Conversion<std::optional< ::smoke::Nullable::SomeStruct >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->method_with_some_struct(Conversion<std::optional< ::smoke::Nullable::SomeStruct >>::toCpp(input)));
}
_baseRef smoke_Nullable_methodWithSomeEnum(_baseRef _instance, _baseRef input) {
    return Conversion<std::optional< ::smoke::Nullable::SomeEnum >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->method_with_some_enum(Conversion<std::optional< ::smoke::Nullable::SomeEnum >>::toCpp(input)));
}
_baseRef smoke_Nullable_methodWithSomeArray(_baseRef _instance, _baseRef input) {
    return Conversion<std::optional< ::std::vector< ::std::string > >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->method_with_some_array(Conversion<std::optional< ::std::vector< ::std::string > >>::toCpp(input)));
}
_baseRef smoke_Nullable_methodWithInlineArray(_baseRef _instance, _baseRef input) {
    return Conversion<std::optional< ::std::vector< ::std::string > >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->method_with_inline_array(Conversion<std::optional< ::std::vector< ::std::string > >>::toCpp(input)));
}
_baseRef smoke_Nullable_methodWithSomeMap(_baseRef _instance, _baseRef input) {
    return Conversion<std::optional< ::std::unordered_map< int64_t, ::std::string > >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->method_with_some_map(Conversion<std::optional< ::std::unordered_map< int64_t, ::std::string > >>::toCpp(input)));
}
...
_baseRef smoke_Nullable_stringProperty_get(_baseRef _instance) {
    return Conversion<std::optional< ::std::string >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->get_string_property());
}
void smoke_Nullable_stringProperty_set(_baseRef _instance, _baseRef value) {
    return get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->set_string_property(Conversion<std::optional< ::std::string >>::toCpp(value));
}
_baseRef smoke_Nullable_isBoolProperty_get(_baseRef _instance) {
    return Conversion<std::optional< bool >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->is_bool_property());
}
void smoke_Nullable_isBoolProperty_set(_baseRef _instance, _baseRef value) {
    return get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->set_bool_property(Conversion<std::optional< bool >>::toCpp(value));
}
_baseRef smoke_Nullable_doubleProperty_get(_baseRef _instance) {
    return Conversion<std::optional< double >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->get_double_property());
}
void smoke_Nullable_doubleProperty_set(_baseRef _instance, _baseRef value) {
    return get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->set_double_property(Conversion<std::optional< double >>::toCpp(value));
}
_baseRef smoke_Nullable_intProperty_get(_baseRef _instance) {
    return Conversion<std::optional< int64_t >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->get_int_property());
}
void smoke_Nullable_intProperty_set(_baseRef _instance, _baseRef value) {
    return get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->set_int_property(Conversion<std::optional< int64_t >>::toCpp(value));
}
_baseRef smoke_Nullable_structProperty_get(_baseRef _instance) {
    return Conversion<std::optional< ::smoke::Nullable::SomeStruct >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->get_struct_property());
}
void smoke_Nullable_structProperty_set(_baseRef _instance, _baseRef value) {
    return get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->set_struct_property(Conversion<std::optional< ::smoke::Nullable::SomeStruct >>::toCpp(value));
}
_baseRef smoke_Nullable_enumProperty_get(_baseRef _instance) {
    return Conversion<std::optional< ::smoke::Nullable::SomeEnum >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->get_enum_property());
}
void smoke_Nullable_enumProperty_set(_baseRef _instance, _baseRef value) {
    return get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->set_enum_property(Conversion<std::optional< ::smoke::Nullable::SomeEnum >>::toCpp(value));
}
_baseRef smoke_Nullable_arrayProperty_get(_baseRef _instance) {
    return Conversion<std::optional< ::std::vector< ::std::string > >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->get_array_property());
}
void smoke_Nullable_arrayProperty_set(_baseRef _instance, _baseRef value) {
    return get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->set_array_property(Conversion<std::optional< ::std::vector< ::std::string > >>::toCpp(value));
}
_baseRef smoke_Nullable_inlineArrayProperty_get(_baseRef _instance) {
    return Conversion<std::optional< ::std::vector< ::std::string > >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->get_inline_array_property());
}
void smoke_Nullable_inlineArrayProperty_set(_baseRef _instance, _baseRef value) {
    return get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->set_inline_array_property(Conversion<std::optional< ::std::vector< ::std::string > >>::toCpp(value));
}
_baseRef smoke_Nullable_mapProperty_get(_baseRef _instance) {
    return Conversion<std::optional< ::std::unordered_map< int64_t, ::std::string > >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->get_map_property());
}
void smoke_Nullable_mapProperty_set(_baseRef _instance, _baseRef value) {
    return get_pointer<::std::shared_ptr< ::smoke::Nullable >>(_instance)->get()->set_map_property(Conversion<std::optional< ::std::unordered_map< int64_t, ::std::string > >>::toCpp(value));
}
...
{
    auto _struct = new ( ::std::nothrow ) std::optional<::smoke::Nullable::SomeStruct>( ::smoke::Nullable::SomeStruct( ) );
    (*_struct)->string_field = Conversion<::std::string>::toCpp( stringField );
    return reinterpret_cast<_baseRef>( _struct );
}
_baseRef
...
{
    return reinterpret_cast<_baseRef>( &**reinterpret_cast<std::optional<::smoke::Nullable::SomeStruct>*>( handle ) );
}
...
smoke_Nullable_NullableStruct_create_handle( _baseRef stringField, _baseRef boolField, _baseRef doubleField, _baseRef structField, _baseRef enumField, _baseRef arrayField, _baseRef inlineArrayField, _baseRef mapField, _baseRef instanceField )
{
    ...
    _struct->string_field = Conversion<std::optional< ::std::string >>::toCpp( stringField );
    _struct->bool_field = Conversion<std::optional< bool >>::toCpp( boolField );
    _struct->double_field = Conversion<std::optional< double >>::toCpp( doubleField );
    _struct->struct_field = Conversion<std::optional< ::smoke::Nullable::SomeStruct >>::toCpp( structField );
    _struct->enum_field = Conversion<std::optional< ::smoke::Nullable::SomeEnum >>::toCpp( enumField );
    _struct->array_field = Conversion<std::optional< ::std::vector< ::std::string > >>::toCpp( arrayField );
    _struct->inline_array_field = Conversion<std::optional< ::std::vector< ::std::string > >>::toCpp( inlineArrayField );
    _struct->map_field = Conversion<std::optional< ::std::unordered_map< int64_t, ::std::string > >>::toCpp( mapField );
...
{
    auto _struct = new ( ::std::nothrow ) std::optional<::smoke::Nullable::NullableStruct>( ::smoke::Nullable::NullableStruct( ) );
    (*_struct)->string_field = Conversion<std::optional< ::std::string >>::toCpp( stringField );
    (*_struct)->bool_field = Conversion<std::optional< bool >>::toCpp( boolField );
    (*_struct)->double_field = Conversion<std::optional< double >>::toCpp( doubleField );
    (*_struct)->struct_field = Conversion<std::optional< ::smoke::Nullable::SomeStruct >>::toCpp( structField );
...
{
    return reinterpret_cast<_baseRef>( &**reinterpret_cast<std::optional<::smoke::Nullable::NullableStruct>*>( handle ) );
}
...
_baseRef smoke_Nullable_NullableStruct_stringField_get(_baseRef handle) {
    ...
    return Conversion<std::optional< ::std::string >>::toBaseRef(struct_pointer->string_field);
}
_baseRef smoke_Nullable_NullableStruct_boolField_get(_baseRef handle) {
    auto struct_pointer = get_pointer<const ::smoke::Nullable::NullableStruct>(handle);
    return Conversion<std::optional< bool >>::toBaseRef(struct_pointer->bool_field);
}
_baseRef smoke_Nullable_NullableStruct_doubleField_get(_baseRef handle) {
    auto struct_pointer = get_pointer<const ::smoke::Nullable::NullableStruct>(handle);
    return Conversion<std::optional< double >>::toBaseRef(struct_pointer->double_field);
}
_baseRef smoke_Nullable_NullableStruct_structField_get(_baseRef handle) {
    auto struct_pointer = get_pointer<const ::smoke::Nullable::NullableStruct>(handle);
    return Conversion<std::optional< ::smoke::Nullable::SomeStruct >>::toBaseRef(struct_pointer->struct_field);
}
_baseRef smoke_Nullable_NullableStruct_enumField_get(_baseRef handle) {
    auto struct_pointer = get_pointer<const ::smoke::Nullable::NullableStruct>(handle);
    return Conversion<std::optional< ::smoke::Nullable::SomeEnum >>::toBaseRef(struct_pointer->enum_field);
}
_baseRef smoke_Nullable_NullableStruct_arrayField_get(_baseRef handle) {
    auto struct_pointer = get_pointer<const ::smoke::Nullable::NullableStruct>(handle);
    return Conversion<std::optional< ::std::vector< ::std::string > >>::toBaseRef(struct_pointer->array_field);
}
_baseRef smoke_Nullable_NullableStruct_inlineArrayField_get(_baseRef handle) {
    auto struct_pointer = get_pointer<const ::smoke::Nullable::NullableStruct>(handle);
    return Conversion<std::optional< ::std::vector< ::std::string > >>::toBaseRef(struct_pointer->inline_array_field);
}
_baseRef smoke_Nullable_NullableStruct_mapField_get(_baseRef handle) {
    auto struct_pointer = get_pointer<const ::smoke::Nullable::NullableStruct>(handle);
    return Conversion<std::optional< ::std::unordered_map< int64_t, ::std::string > >>::toBaseRef(struct_pointer->map_field);
}
...
smoke_Nullable_NullableIntsStruct_create_handle( _baseRef int8Field, _baseRef int16Field, _baseRef int32Field, _baseRef int64Field, _baseRef uint8Field, _baseRef uint16Field, _baseRef uint32Field, _baseRef uint64Field )
{
    ...
    _struct->int8_field = Conversion<std::optional< int8_t >>::toCpp( int8Field );
    _struct->int16_field = Conversion<std::optional< int16_t >>::toCpp( int16Field );
    _struct->int32_field = Conversion<std::optional< int32_t >>::toCpp( int32Field );
    _struct->int64_field = Conversion<std::optional< int64_t >>::toCpp( int64Field );
    _struct->uint8_field = Conversion<std::optional< uint8_t >>::toCpp( uint8Field );
    _struct->uint16_field = Conversion<std::optional< uint16_t >>::toCpp( uint16Field );
    _struct->uint32_field = Conversion<std::optional< uint32_t >>::toCpp( uint32Field );
    _struct->uint64_field = Conversion<std::optional< uint64_t >>::toCpp( uint64Field );
    return reinterpret_cast<_baseRef>( _struct );
}
void
...
{
    auto _struct = new ( ::std::nothrow ) std::optional<::smoke::Nullable::NullableIntsStruct>( ::smoke::Nullable::NullableIntsStruct( ) );
    (*_struct)->int8_field = Conversion<std::optional< int8_t >>::toCpp( int8Field );
    (*_struct)->int16_field = Conversion<std::optional< int16_t >>::toCpp( int16Field );
    (*_struct)->int32_field = Conversion<std::optional< int32_t >>::toCpp( int32Field );
    (*_struct)->int64_field = Conversion<std::optional< int64_t >>::toCpp( int64Field );
...
{
    return reinterpret_cast<_baseRef>( &**reinterpret_cast<std::optional<::smoke::Nullable::NullableIntsStruct>*>( handle ) );
}
...
_baseRef smoke_Nullable_NullableIntsStruct_int8Field_get(_baseRef handle) {
    ...
    return Conversion<std::optional< int8_t >>::toBaseRef(struct_pointer->int8_field);
}
_baseRef smoke_Nullable_NullableIntsStruct_int16Field_get(_baseRef handle) {
    auto struct_pointer = get_pointer<const ::smoke::Nullable::NullableIntsStruct>(handle);
    return Conversion<std::optional< int16_t >>::toBaseRef(struct_pointer->int16_field);
}
_baseRef smoke_Nullable_NullableIntsStruct_int32Field_get(_baseRef handle) {
    auto struct_pointer = get_pointer<const ::smoke::Nullable::NullableIntsStruct>(handle);
    return Conversion<std::optional< int32_t >>::toBaseRef(struct_pointer->int32_field);
}
_baseRef smoke_Nullable_NullableIntsStruct_int64Field_get(_baseRef handle) {
    auto struct_pointer = get_pointer<const ::smoke::Nullable::NullableIntsStruct>(handle);
    return Conversion<std::optional< int64_t >>::toBaseRef(struct_pointer->int64_field);
}
_baseRef smoke_Nullable_NullableIntsStruct_uint8Field_get(_baseRef handle) {
    auto struct_pointer = get_pointer<const ::smoke::Nullable::NullableIntsStruct>(handle);
    return Conversion<std::optional< uint8_t >>::toBaseRef(struct_pointer->uint8_field);
}
_baseRef smoke_Nullable_NullableIntsStruct_uint16Field_get(_baseRef handle) {
    auto struct_pointer = get_pointer<const ::smoke::Nullable::NullableIntsStruct>(handle);
    return Conversion<std::optional< uint16_t >>::toBaseRef(struct_pointer->uint16_field);
}
_baseRef smoke_Nullable_NullableIntsStruct_uint32Field_get(_baseRef handle) {
    auto struct_pointer = get_pointer<const ::smoke::Nullable::NullableIntsStruct>(handle);
    return Conversion<std::optional< uint32_t >>::toBaseRef(struct_pointer->uint32_field);
}
_baseRef smoke_Nullable_NullableIntsStruct_uint64Field_get(_baseRef handle) {
    auto struct_pointer = get_pointer<const ::smoke::Nullable::NullableIntsStruct>(handle);
    return Conversion<std::optional< uint64_t >>::toBaseRef(struct_pointer->uint64_field);
}
