...
public:
    ...
    struct _GLUECODIUM_CPP_EXPORT NullableStruct {
        ...
        ::gluecodium::optional< double > double_field = ::gluecodium::optional< double >();
        ::gluecodium::optional< ::smoke::Nullable::SomeStruct > struct_field = ::gluecodium::optional< ::smoke::Nullable::SomeStruct >();
        ::gluecodium::optional< ::smoke::Nullable::SomeEnum > enum_field = ::gluecodium::optional< ::smoke::Nullable::SomeEnum >();
        ::gluecodium::optional< ::smoke::Nullable::SomeArray > array_field = ::gluecodium::optional< ::smoke::Nullable::SomeArray >();
        ::gluecodium::optional< ::std::vector< ::std::string > > inline_array_field = ::gluecodium::optional< ::std::vector< ::std::string > >();
        ::gluecodium::optional< ::smoke::Nullable::SomeMap > map_field = ::gluecodium::optional< ::smoke::Nullable::SomeMap >();
    ...
    struct _GLUECODIUM_CPP_EXPORT NullableIntsStruct {
        ::gluecodium::optional< int8_t > int8_field = ::gluecodium::optional< int8_t >();
        ::gluecodium::optional< int16_t > int16_field = ::gluecodium::optional< int16_t >();
        ::gluecodium::optional< int32_t > int32_field = ::gluecodium::optional< int32_t >();
        ::gluecodium::optional< int64_t > int64_field = ::gluecodium::optional< int64_t >();
        ::gluecodium::optional< uint8_t > uint8_field = ::gluecodium::optional< uint8_t >();
        ::gluecodium::optional< uint16_t > uint16_field = ::gluecodium::optional< uint16_t >();
        ::gluecodium::optional< uint32_t > uint32_field = ::gluecodium::optional< uint32_t >();
        ::gluecodium::optional< uint64_t > uint64_field = ::gluecodium::optional< uint64_t >();
        NullableIntsStruct( );
