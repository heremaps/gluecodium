...
final _smoke_InheritFromSkipped_get_raw_pointer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
      Pointer<Void> Function(Pointer<Void>),
      Pointer<Void> Function(Pointer<Void>)
    >('library_smoke_InheritFromSkipped_get_raw_pointer'));
...
class InheritFromSkipped$Impl extends SkipProxy$Impl implements InheritFromSkipped {
  ...
  void release() {
    ...
    __lib.reverseCache.remove(_smoke_InheritFromSkipped_get_raw_pointer(handle));
...
Pointer<Void> smoke_InheritFromSkipped_toFfi(InheritFromSkipped value) {
  ...
  __lib.reverseCache[_smoke_InheritFromSkipped_get_raw_pointer(result)] = value;
  return result;
}
