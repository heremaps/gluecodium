...
com_example_smoke_EnableTagsInJava_CppProxy::com_example_smoke_EnableTagsInJava_CppProxy(JniReference<jobject> globalRef, jint _jHashCode) noexcept
    : CppProxyBase(std::move(globalRef), _jHashCode, "com_example_smoke_EnableTagsInJava") {
}
