...
{
    auto _struct = new ( ::std::nothrow ) std::optional<::smoke::SkipField>( ::smoke::SkipField( ) );
    (*_struct)->field = Conversion<::std::string>::toCpp( field );
    return reinterpret_cast<_baseRef>( _struct );
}
_baseRef
...
{
    return reinterpret_cast<_baseRef>( &**reinterpret_cast<std::optional<::smoke::SkipField>*>( handle ) );
}
