...
{
    auto _struct = new ( ::std::nothrow ) ::gluecodium::optional<::smoke::ClassWithStructWithSkipLambdaInPlatform::SkipLambdaInPlatform>( ::smoke::ClassWithStructWithSkipLambdaInPlatform::SkipLambdaInPlatform( ) );
    (*_struct)->int_field = intField;
...
{
    return reinterpret_cast<_baseRef>( &**reinterpret_cast<::gluecodium::optional<::smoke::ClassWithStructWithSkipLambdaInPlatform::SkipLambdaInPlatform>*>( handle ) );
}

void smoke_ClassWithStructWithSkipLambdaInPlatform_SkipLambdaInPlatform_release_optional_handle(_baseRef handle) {
    delete reinterpret_cast<::gluecodium::optional<::smoke::ClassWithStructWithSkipLambdaInPlatform::SkipLambdaInPlatform>*>( handle );
}
