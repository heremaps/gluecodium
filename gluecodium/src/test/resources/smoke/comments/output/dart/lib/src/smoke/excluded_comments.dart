...
int _ExcludedComments_SomeLambda_call_static(Object _obj, Pointer<Void> p0, int p1, Pointer<Double> _result) {
  double _result_object;
  try {
    _result_object = (_obj as ExcludedComments_SomeLambda)(String_fromFfi(p0), (p1));
...
Pointer<Void> smoke_ExcludedComments_SomeLambda_toFfi(ExcludedComments_SomeLambda value) {
  final result = _smoke_ExcludedComments_SomeLambda_create_proxy(
    ...
    value,
    Pointer.fromFunction<Int64 Function(Handle, Pointer<Void>, Int32, Pointer<Double>)>(_ExcludedComments_SomeLambda_call_static, __lib.unknownError)
  );
  return result;
}
