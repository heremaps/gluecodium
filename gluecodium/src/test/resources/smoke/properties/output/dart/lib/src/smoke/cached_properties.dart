...
final _smoke_CachedProperties_register_finalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
CachedProperties smoke_CachedProperties_fromFfi(Pointer<Void> handle) {
  ...
  __lib.cacheInstance(_copied_handle, result, _smoke_CachedProperties_register_finalizer);
  return result;
}
