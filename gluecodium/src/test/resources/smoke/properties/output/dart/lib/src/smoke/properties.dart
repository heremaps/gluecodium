...
final _smoke_Properties_register_finalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
Properties smoke_Properties_fromFfi(Pointer<Void> handle) {
  ...
  __lib.cacheInstance(_copied_handle, result, _smoke_Properties_register_finalizer);
  return result;
}
