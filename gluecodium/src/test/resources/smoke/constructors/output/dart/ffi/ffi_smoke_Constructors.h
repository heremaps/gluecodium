...
extern "C" {
#endif
_GLUECODIUM_FFI_EXPORT FfiOpaqueHandle library_smoke_Constructors_create();
_GLUECODIUM_FFI_EXPORT FfiOpaqueHandle library_smoke_Constructors_create__Constructors(FfiOpaqueHandle other);
_GLUECODIUM_FFI_EXPORT FfiOpaqueHandle library_smoke_Constructors_create__String_ULong(FfiOpaqueHandle foo, uint64_t bar);
...
_GLUECODIUM_FFI_EXPORT FfiOpaqueHandle library_smoke_Constructors_create__String(FfiOpaqueHandle input);
_GLUECODIUM_FFI_EXPORT FfiOpaqueHandle library_smoke_Constructors_create__ListOf_1Double(FfiOpaqueHandle input);
