...
final _smoke_AttributesWithComments_register_finalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
AttributesWithComments smoke_AttributesWithComments_fromFfi(Pointer<Void> handle) {
  ...
  __lib.cacheInstance(_copied_handle, result, _smoke_AttributesWithComments_register_finalizer);
  return result;
}
