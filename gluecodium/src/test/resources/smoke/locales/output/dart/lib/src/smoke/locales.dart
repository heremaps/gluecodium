...
final _smoke_Locales_register_finalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
Locales smoke_Locales_fromFfi(Pointer<Void> handle) {
  ...
  __lib.cacheInstance(_copied_handle, result, _smoke_Locales_register_finalizer);
  return result;
}
