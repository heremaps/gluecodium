...
final _smoke_ExternalInterface_register_finalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
ExternalInterface smoke_ExternalInterface_fromFfi(Pointer<Void> handle) {
  ...
  __lib.cacheInstance(_copied_handle, result, _smoke_ExternalInterface_register_finalizer);
  return result;
}
