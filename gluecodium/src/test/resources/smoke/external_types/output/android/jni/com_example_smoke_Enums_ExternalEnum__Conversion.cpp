...
convert_from_jni(JNIEnv* _jenv, const JniReference<jobject>& _jinput, TypeId<::gluecodium::optional<::smoke::Enums::External_Enum>>)
{
    return _jinput
        ? ::gluecodium::optional<::smoke::Enums::External_Enum>(convert_from_jni(_jenv, _jinput, TypeId<::smoke::Enums::External_Enum>{}))
        : ::gluecodium::optional<::smoke::Enums::External_Enum>{};
}
