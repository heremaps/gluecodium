...
convert_from_jni(JNIEnv* _jenv, const JniReference<jobject>& _jinput, TypeId<::gluecodium::optional<std::chrono::duration<uint64_t, std::ratio<1,1000>>>>)
{
    return _jinput
        ? ::gluecodium::optional<std::chrono::duration<uint64_t, std::ratio<1,1000>>>(convert_from_jni(_jenv, _jinput, TypeId<std::chrono::duration<uint64_t, std::ratio<1,1000>>>{}))
        : ::gluecodium::optional<std::chrono::duration<uint64_t, std::ratio<1,1000>>>{};
}
