...
convert_from_jni(JNIEnv* _jenv, const JniReference<jobject>& _jinput_ext, TypeId<::smoke::Season>)
{
    ...
    if (convertMethodId == NULL) {
        throw_new_runtime_exception(_jenv, "Static method 'convertToInternal(Ljava/lang/String;)Lcom/example/smoke/Season;' not found.");
        return {};
    }
...
convert_from_jni(JNIEnv* _jenv, const JniReference<jobject>& _jinput, TypeId<::gluecodium::optional<::smoke::Season>>)
{
    return _jinput
        ? ::gluecodium::optional<::smoke::Season>(convert_from_jni(_jenv, _jinput, TypeId<::smoke::Season>{}))
        : ::gluecodium::optional<::smoke::Season>{};
}
...
convert_to_jni(JNIEnv* _jenv, const ::smoke::Season _ninput)
{
    ...
    if (convertMethodId == NULL) {
        throw_new_runtime_exception(_jenv, "Static method 'convertFromInternal(Lcom/example/smoke/Season;)Ljava/lang/String;' not found.");
        return {};
    }
