...
convert_from_jni(JNIEnv* _jenv, const JniReference<jobject>& _jinput_ext, ::smoke::JavaExternalCtor*)
{
    ...
    if (convertMethodId == NULL) {
        throw_runtime_exception(_jenv, "Static method 'convertToInternal(Lcom/example/Foo;)Lcom/example/smoke/JavaExternalCtor;' not found.");
        return {};
    }
...
convert_to_jni(JNIEnv* _jenv, const ::smoke::JavaExternalCtor& _ninput)
{
    ...
    if (convertMethodId == NULL) {
        throw_runtime_exception(_jenv, "Static method 'convertFromInternal(Lcom/example/smoke/JavaExternalCtor;)Lcom/example/Foo;' not found.");
        return {};
    }
