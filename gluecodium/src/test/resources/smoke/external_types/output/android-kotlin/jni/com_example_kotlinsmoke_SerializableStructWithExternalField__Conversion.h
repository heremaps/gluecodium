...
JNIEXPORT ::gluecodium::optional<::kotlin_smoke::SerializableStructWithExternalField> convert_from_jni(JNIEnv* _jenv, const JniReference<jobject>& _jinput, TypeId<::gluecodium::optional<::kotlin_smoke::SerializableStructWithExternalField>>);
...
JNIEXPORT JniReference<jobject> convert_to_jni(JNIEnv* _jenv, const ::gluecodium::optional<::kotlin_smoke::SerializableStructWithExternalField> _ninput);
}
}
