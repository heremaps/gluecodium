...
{
    auto _struct = new ( ::std::nothrow ) std::optional<::smoke::Structs::ExternalStruct>( ::smoke::Structs::ExternalStruct( ) );
    (*_struct)->stringField = Conversion<::std::string>::toCpp( stringField );
    (*_struct)->set_some_string( Conversion<::std::string>::toCpp( externalStringField ) );
    (*_struct)->set_some_array( Conversion<::std::vector< int8_t >>::toCpp( externalArrayField ) );
    (*_struct)->set_some_struct( Conversion<::fire::SomeVeryExternalStruct>::toCpp( externalStructField ) );
...
{
    return reinterpret_cast<_baseRef>( &**reinterpret_cast<std::optional<::smoke::Structs::ExternalStruct>*>( handle ) );
}
...
{
    auto _struct = new ( ::std::nothrow ) std::optional<::fire::SomeVeryExternalStruct>( ::fire::SomeVeryExternalStruct( ) );
    (*_struct)->intField = intField;
    return reinterpret_cast<_baseRef>( _struct );
}
_baseRef
...
{
    return reinterpret_cast<_baseRef>( &**reinterpret_cast<std::optional<::fire::SomeVeryExternalStruct>*>( handle ) );
}
