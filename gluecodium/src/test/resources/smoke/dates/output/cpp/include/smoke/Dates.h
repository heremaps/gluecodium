...
public:
    ...
    struct _GLUECODIUM_CPP_EXPORT DateStruct {
        ...
        std::optional< ::std::chrono::system_clock::time_point > nullable_date_field = std::optional< ::std::chrono::system_clock::time_point >();

        DateStruct( );
        explicit DateStruct( ::std::chrono::system_clock::time_point date_field );
        DateStruct( ::std::chrono::system_clock::time_point date_field, std::optional< ::std::chrono::system_clock::time_point > nullable_date_field );

    };

public:
    virtual ::std::chrono::system_clock::time_point date_method( const ::std::chrono::system_clock::time_point& input ) = 0;
    virtual std::optional< ::std::chrono::system_clock::time_point > nullable_date_method( const std::optional< ::std::chrono::system_clock::time_point >& input ) = 0;
