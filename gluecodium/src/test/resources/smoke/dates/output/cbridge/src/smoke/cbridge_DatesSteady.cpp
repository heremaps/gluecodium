...
_baseRef smoke_DatesSteady_nullableDateMethod(_baseRef _instance, _baseRef input) {
    return Conversion<std::optional< std::chrono::steady_clock::time_point >>::toBaseRef(get_pointer<::std::shared_ptr< ::smoke::DatesSteady >>(_instance)->get()->nullable_date_method(Conversion<std::optional< std::chrono::steady_clock::time_point >>::toCpp(input)));
}
...
smoke_DatesSteady_DateStruct_create_handle( double dateField, _baseRef nullableDateField )
{
    ...
    _struct->nullable_date_field = Conversion<std::optional< std::chrono::steady_clock::time_point >>::toCpp( nullableDateField );
...
{
    auto _struct = new ( ::std::nothrow ) std::optional<::smoke::DatesSteady::DateStruct>( ::smoke::DatesSteady::DateStruct( ) );
    (*_struct)->date_field = Conversion<std::chrono::steady_clock::time_point>::toCpp( dateField );
    (*_struct)->nullable_date_field = Conversion<std::optional< std::chrono::steady_clock::time_point >>::toCpp( nullableDateField );
    return reinterpret_cast<_baseRef>( _struct );
}
...
{
    return reinterpret_cast<_baseRef>( &**reinterpret_cast<std::optional<::smoke::DatesSteady::DateStruct>*>( handle ) );
}
...
_baseRef smoke_DatesSteady_DateStruct_nullableDateField_get(_baseRef handle) {
    auto struct_pointer = get_pointer<const ::smoke::DatesSteady::DateStruct>(handle);
    return Conversion<std::optional< std::chrono::steady_clock::time_point >>::toBaseRef(struct_pointer->nullable_date_field);
}
