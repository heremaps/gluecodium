...
namespace jni
{
com_example_smoke_ListenersWithReturnValues_CppProxy::com_example_smoke_ListenersWithReturnValues_CppProxy( JNIEnv* _jenv, JniReference<jobject> globalRef, jint _jHashCode )
    : CppProxyBase( _jenv, std::move( globalRef ), _jHashCode, "com_example_smoke_ListenersWithReturnValues" ) {
}
double
