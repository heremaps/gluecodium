...
namespace jni
{
com_example_smoke_CalculatorListener_CppProxy::com_example_smoke_CalculatorListener_CppProxy( JNIEnv* _jenv, JniReference<jobject> globalRef, jint _jHashCode )
    : CppProxyBase( _jenv, std::move( globalRef ), _jHashCode, "com_example_smoke_CalculatorListener" ) {
}
void
