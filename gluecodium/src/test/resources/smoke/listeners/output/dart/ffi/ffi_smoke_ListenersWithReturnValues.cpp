...
public:
    ...
    fetch_data_string() override {
        ...
        dispatch([&]() { (*reinterpret_cast<int64_t (*)(uint64_t, FfiOpaqueHandle*)>(f1))(token,
            &_result_handle
        ); });
    ...
    fetch_data_enum() override {
        ...
        dispatch([&]() { (*reinterpret_cast<int64_t (*)(uint64_t, uint32_t*)>(f3))(token,
            &_result_handle
        ); });
    ...
    fetch_data_instance() override {
        FfiOpaqueHandle _result_handle;
        dispatch([&]() { (*reinterpret_cast<int64_t (*)(uint64_t, FfiOpaqueHandle*)>(f6))(token,
            &_result_handle
        ); });
