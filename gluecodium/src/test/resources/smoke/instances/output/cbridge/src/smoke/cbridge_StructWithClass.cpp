...
{
    auto _struct = new ( ::std::nothrow ) std::optional<::smoke::StructWithClass>( ::smoke::StructWithClass( ) );
    (*_struct)->class_instance = Conversion<::std::shared_ptr< ::smoke::SimpleClass >>::toCpp( classInstance );
    return reinterpret_cast<_baseRef>( _struct );
}
_baseRef
...
{
    return reinterpret_cast<_baseRef>( &**reinterpret_cast<std::optional<::smoke::StructWithClass>*>( handle ) );
}
