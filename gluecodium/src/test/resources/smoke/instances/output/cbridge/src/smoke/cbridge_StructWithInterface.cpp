...
{
    auto _struct = new ( ::std::nothrow ) std::optional<::smoke::StructWithInterface>( ::smoke::StructWithInterface( ) );
    (*_struct)->interface_instance = Conversion<::std::shared_ptr< ::smoke::SimpleInterface >>::toCpp( interfaceInstance );
    return reinterpret_cast<_baseRef>( _struct );
}
_baseRef
...
{
    return reinterpret_cast<_baseRef>( &**reinterpret_cast<std::optional<::smoke::StructWithInterface>*>( handle ) );
}
