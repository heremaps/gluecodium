...
namespace jni
{
REGISTER_JNI_CLASS_CACHE_INHERITANCE("com/example/smoke/ExternalInterfaceImpl", com_example_smoke_ExternalInterfaceImpl, "smoke_ExternalInterface", ::smoke::ExternalInterface)
template<>
