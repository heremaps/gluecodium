...
::gluecodium::optional<::fire::Baz::some_Struct>
convert_from_jni(JNIEnv* _jenv, const JniReference<jobject>& _jinput, ::gluecodium::optional<::fire::Baz::some_Struct>* dummy)
{
    return _jinput
        ? ::gluecodium::optional<::fire::Baz::some_Struct>(convert_from_jni(_jenv, _jinput, (::fire::Baz::some_Struct*)nullptr))
        : ::gluecodium::optional<::fire::Baz::some_Struct>{};
}
...
convert_to_jni(JNIEnv* _jenv, const ::fire::Baz::some_Struct& _ninput)
{
    ...
    ::gluecodium::jni::set_field_value(_jenv, _jresult, "someField", jsome_Field);
    return _jresult;
}
JniReference<jobject>
convert_to_jni(JNIEnv* _jenv, const ::gluecodium::optional<::fire::Baz::some_Struct> _ninput)
{
...
::gluecodium::optional<::smoke::ExternalInterface::some_Struct>
convert_from_jni(JNIEnv* _jenv, const JniReference<jobject>& _jinput, ::gluecodium::optional<::smoke::ExternalInterface::some_Struct>* dummy)
{
    return _jinput
        ? ::gluecodium::optional<::smoke::ExternalInterface::some_Struct>(convert_from_jni(_jenv, _jinput, (::smoke::ExternalInterface::some_Struct*)nullptr))
        : ::gluecodium::optional<::smoke::ExternalInterface::some_Struct>{};
}
...
JniReference<jobject>
convert_to_jni(JNIEnv* _jenv, const ::gluecodium::optional<::smoke::ExternalInterface::some_Struct> _ninput)
{
    return _ninput ? convert_to_jni(_jenv, *_ninput) : JniReference<jobject>{};
}
...
convert_to_jni(JNIEnv* _jenv, const ::smoke::StructWithInstances& _ninput)
{
    ...
    ::gluecodium::jni::set_object_field_value(_jenv, _jresult, "classInstance",
        "Lcom/example/smoke/SimpleClass;", jclass_instance);
    auto jinterface_instance = convert_to_jni(_jenv, _ninput.interface_instance);
    ::gluecodium::jni::set_object_field_value(_jenv, _jresult, "interfaceInstance",
