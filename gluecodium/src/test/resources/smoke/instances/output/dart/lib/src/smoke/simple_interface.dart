...
int _SimpleInterface_getStringValue_static(Object _obj, Pointer<Pointer<Void>> _result) {
  String _result_object = null;
  try {
    _result_object = (_obj as SimpleInterface).getStringValue();
    _result.value = String_toFfi(_result_object);
  } finally {
  }
  return 0;
}
int _SimpleInterface_useSimpleInterface_static(Object _obj, Pointer<Void> input, Pointer<Pointer<Void>> _result) {
  SimpleInterface _result_object = null;
  try {
    _result_object = (_obj as SimpleInterface).useSimpleInterface(smoke_SimpleInterface_fromFfi(input));
...
Pointer<Void> smoke_SimpleInterface_toFfi(SimpleInterface value) {
  ...
  final result = _smoke_SimpleInterface_create_proxy(
    ...
    value,
    Pointer.fromFunction<Uint8 Function(Handle, Pointer<Pointer<Void>>)>(_SimpleInterface_getStringValue_static, __lib.unknownError),
    Pointer.fromFunction<Uint8 Function(Handle, Pointer<Void>, Pointer<Pointer<Void>>)>(_SimpleInterface_useSimpleInterface_static, __lib.unknownError)
  );
  return result;
}
