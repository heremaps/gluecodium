...
_GLUECODIUM_FFI_EXPORT void library_smoke_StructWithInterface_release_handle_nullable(FfiOpaqueHandle handle);
_GLUECODIUM_FFI_EXPORT FfiOpaqueHandle library_smoke_StructWithInterface_get_value_nullable(FfiOpaqueHandle handle);
#ifdef __cplusplus
}
#endif
