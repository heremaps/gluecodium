...
final _smoke_off_NestedPackages_register_finalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
NestedPackages smoke_off_NestedPackages_fromFfi(Pointer<Void> handle) {
  ...
  __lib.cacheInstance(_copied_handle, result, _smoke_off_NestedPackages_register_finalizer);
  return result;
}
