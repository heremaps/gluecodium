...
class LimeOptimizedListsValidatorTest(private val limeElement: LimeNamedElement, private val expectedResult: Boolean) {
    ...
    companion object {
        ...
        fun testData() = listOf(
            ...
            arrayOf(object : LimeContainerWithInheritance(EMPTY_PATH, parent = typeRef) {}, true),
            arrayOf(object : LimeContainerWithInheritance(EMPTY_PATH, parent = optimizedListTypeRef) {}, false),
