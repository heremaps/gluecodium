...
public class EquatableValidatorPredicateTest {
  ...
  private final EquatableValidatorPredicate validatorPredicate = new EquatableValidatorPredicate();
  ...
  @Test
  public void validateWithFieldInNonEquatableStruct() {
  ...
  @Test
  public void validateWithEquatableStructType() {
    FStructType equatableStruct = mock(FStructType.class);
    when(deploymentModel.isEquatable(equatableStruct)).thenReturn(true);
    when(francaTypeRef.getDerived()).thenReturn(equatableStruct);
