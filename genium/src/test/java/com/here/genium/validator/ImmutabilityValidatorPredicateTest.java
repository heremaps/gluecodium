...
public final class ImmutabilityValidatorPredicateTest {
  ...
  private final ImmutabilityValidatorPredicate validatorPredicate =
  ...
  @Test
  public void validateImmutableWithNoParent() {
    when(francaStruct.getBase()).thenReturn(null);
  ...
  @Test
  public void validateWithImmutableParent() {
  ...
  @Test
  public void validateImmutableWithParent() {
    when(deploymentModel.isImmutable(francaStruct)).thenReturn(true);
  ...
  @Test
  public void validateImmutableWithImmutableParent() {
    when(deploymentModel.isImmutable(francaStruct)).thenReturn(true);
    when(deploymentModel.isImmutable(parentStruct)).thenReturn(true);
