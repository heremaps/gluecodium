...
#include <stdbool.h>
#include <stdint.h>
typedef uint32_t smoke_ErrorsInterface_InternalErrorCode;
typedef uint32_t smoke_ErrorsInterface_ExternalErrors;
typedef struct {
    bool has_value;
    union {
        smoke_ErrorsInterface_InternalErrorCode error_code;
...
typedef struct {
    ...
    smoke_ErrorsInterface_InternalErrorCode(*smoke_ErrorsInterface_methodWithErrors)(void* swift_pointer);
...
_GENIUM_C_EXPORT smoke_ErrorsInterface_InternalErrorCode smoke_ErrorsInterface_methodWithErrors(_baseRef _instance);
