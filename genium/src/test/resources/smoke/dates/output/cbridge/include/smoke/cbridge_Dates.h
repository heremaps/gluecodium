...
#include <stdint.h>
#include <stdbool.h>
_GENIUM_C_EXPORT _baseRef smoke_Dates_DateStruct_create_handle(int64_t dateField);
_GENIUM_C_EXPORT void smoke_Dates_DateStruct_release_handle(_baseRef handle);
_GENIUM_C_EXPORT _baseRef smoke_Dates_DateStruct_create_optional_handle(int64_t dateField);
...
_GENIUM_C_EXPORT int64_t smoke_Dates_DateStruct_dateField_get(_baseRef handle);
...
_GENIUM_C_EXPORT int64_t smoke_Dates_dateMethod(_baseRef _instance, int64_t input);
_GENIUM_C_EXPORT int64_t smoke_Dates_dateAttribute_get(_baseRef _instance);
_GENIUM_C_EXPORT void smoke_Dates_dateAttribute_set(_baseRef _instance, int64_t newValue);
...
_GENIUM_C_EXPORT void smoke_Dates_DateMap_put(_baseRef handle, _baseRef key, int64_t value);
...
_GENIUM_C_EXPORT int64_t smoke_Dates_DateMap_iterator_value(_baseRef iterator_handle);
