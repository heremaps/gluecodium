...
{
    auto _struct = new ( std::nothrow ) ::genium::optional<::smoke::ListenerWithProperties::ResultStruct>( ::smoke::ListenerWithProperties::ResultStruct( ) );
    (*_struct)->result = result;
    return reinterpret_cast<_baseRef>( _struct );
}
_baseRef
...
{
    return reinterpret_cast<_baseRef>( &**reinterpret_cast<::genium::optional<::smoke::ListenerWithProperties::ResultStruct>*>( handle ) );
}
...
_baseRef smoke_ListenerWithProperties_create_proxy(smoke_ListenerWithProperties_FunctionTable functionTable) {
    ...
    return proxy ? reinterpret_cast<_baseRef>(new std::shared_ptr<::smoke::ListenerWithProperties>(std::move(proxy))) : 0;
}
