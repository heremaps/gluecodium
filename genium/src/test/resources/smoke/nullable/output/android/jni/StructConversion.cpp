...
convert_from_jni(JNIEnv* _jenv, const JniReference<jobject>& _jinput, ::smoke::NullableCollectionsStruct* dummy)
{
    ...
    ::std::vector< ::genium::optional< ::std::chrono::system_clock::time_point > > n_dates = convert_from_jni(
        _jenv,
        ::genium::jni::get_object_field_value(
        _jenv,
        _jinput,
        "dates",
        "Ljava/util/List;"),
        (::std::vector< ::genium::optional< ::std::chrono::system_clock::time_point > >*)nullptr );
    _nout.dates = n_dates;
    ::std::unordered_map< int32_t, ::genium::optional< ::smoke::Nullable::SomeStruct > > n_structs = convert_from_jni(
        _jenv,
        ::genium::jni::get_object_field_value(
        _jenv,
        _jinput,
        "structs",
        "Ljava/util/Map;"),
        (::std::unordered_map< int32_t, ::genium::optional< ::smoke::Nullable::SomeStruct > >*)nullptr );
    _nout.structs = n_structs;
    return _nout;
}
::genium::optional<::smoke::NullableCollectionsStruct>
convert_from_jni(JNIEnv* _jenv, const JniReference<jobject>& _jinput, ::genium::optional<::smoke::NullableCollectionsStruct>* dummy)
{
    return _jinput
        ? ::genium::optional<::smoke::NullableCollectionsStruct>(convert_from_jni(_jenv, _jinput, (::smoke::NullableCollectionsStruct*)nullptr))
        : ::genium::optional<::smoke::NullableCollectionsStruct>{};
}
...
convert_to_jni(JNIEnv* _jenv, const ::smoke::NullableCollectionsStruct& _ninput)
{
    ...
    ::genium::jni::set_object_field_value(_jenv, _jresult, "dates",
        "Ljava/util/List;", jdates);
    auto jstructs = convert_to_jni(_jenv, _ninput.structs);
    ::genium::jni::set_object_field_value(_jenv, _jresult, "structs",
        "Ljava/util/Map;", jstructs);
    return _jresult;
}
JniReference<jobject>
convert_to_jni(JNIEnv* _jenv, const ::genium::optional<::smoke::NullableCollectionsStruct> _ninput)
{
    return _ninput ? convert_to_jni(_jenv, *_ninput) : JniReference<jobject>{};
}
}
