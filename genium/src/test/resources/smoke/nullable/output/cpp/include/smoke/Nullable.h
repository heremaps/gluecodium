...
public:
    ...
    virtual ::genium::optional< ::std::string > get_string_property(  ) const = 0;
    virtual void set_string_property( const ::genium::optional< ::std::string >& value ) = 0;
    virtual ::genium::optional< bool > is_bool_property(  ) const = 0;
    virtual void set_bool_property( const ::genium::optional< bool >& value ) = 0;
    virtual ::genium::optional< double > get_double_property(  ) const = 0;
    virtual void set_double_property( const ::genium::optional< double >& value ) = 0;
    virtual ::genium::optional< int64_t > get_int_property(  ) const = 0;
    virtual void set_int_property( const ::genium::optional< int64_t >& value ) = 0;
    virtual ::genium::optional< ::smoke::Nullable::SomeStruct > get_struct_property(  ) const = 0;
    virtual void set_struct_property( const ::genium::optional< ::smoke::Nullable::SomeStruct >& value ) = 0;
    virtual ::genium::optional< ::smoke::Nullable::SomeEnum > get_enum_property(  ) const = 0;
    virtual void set_enum_property( const ::genium::optional< ::smoke::Nullable::SomeEnum >& value ) = 0;
    virtual ::genium::optional< ::smoke::Nullable::SomeArray > get_array_property(  ) const = 0;
    virtual void set_array_property( const ::genium::optional< ::smoke::Nullable::SomeArray >& value ) = 0;
    virtual ::genium::optional< ::std::vector< ::std::string > > get_inline_array_property(  ) const = 0;
    virtual void set_inline_array_property( const ::genium::optional< ::std::vector< ::std::string > >& value ) = 0;
    virtual ::genium::optional< ::smoke::Nullable::SomeMap > get_map_property(  ) const = 0;
    virtual void set_map_property( const ::genium::optional< ::smoke::Nullable::SomeMap >& value ) = 0;
...
struct hash< ::smoke::Nullable::SomeEnum > {
    _GENIUM_CPP_EXPORT std::size_t operator( )( const ::smoke::Nullable::SomeEnum& t ) const;
};
}