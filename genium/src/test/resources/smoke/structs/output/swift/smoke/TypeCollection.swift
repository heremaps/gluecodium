...
public struct Line {
    ...
    internal init?(cLine: _baseRef) {
        ...
        do {
            guard
                let bUnwrapped = Point(cPoint: smoke_TypeCollection_Line_b_get(cLine))
            else {
                return nil
            }
            b = bUnwrapped
...
public struct ColoredLine {
    ...
    internal init?(cColoredLine: _baseRef) {
        ...
        do {
            guard
                let colorUnwrapped = Color(cColor: smoke_TypeCollection_ColoredLine_color_get(cColoredLine))
            else {
                return nil
            }
...
public struct AllTypesStruct {
    ...
    internal init?(cAllTypesStruct: _baseRef) {
        ...
        do {
            guard
                let pointFieldUnwrapped = Point(cPoint: smoke_TypeCollection_AllTypesStruct_pointField_get(cAllTypesStruct))
            else {
                return nil
            }
