...
_GENIUM_C_EXPORT _baseRef smoke_Structs_DoubleNestingImmutableStruct_create_handle(_baseRef nestingStructField);
_GENIUM_C_EXPORT void smoke_Structs_DoubleNestingImmutableStruct_release_handle(_baseRef handle);
_GENIUM_C_EXPORT _baseRef smoke_Structs_DoubleNestingImmutableStruct_create_optional_handle(_baseRef nestingStructField);
_GENIUM_C_EXPORT _baseRef smoke_Structs_DoubleNestingImmutableStruct_unwrap_optional_handle(_baseRef handle);
_GENIUM_C_EXPORT void smoke_Structs_DoubleNestingImmutableStruct_release_optional_handle(_baseRef handle);
_GENIUM_C_EXPORT _baseRef smoke_Structs_DoubleNestingImmutableStruct_nestingStructField_get(_baseRef handle);
