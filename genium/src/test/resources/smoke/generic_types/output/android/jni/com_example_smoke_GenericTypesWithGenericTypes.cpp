...
{
    ::std::vector< ::std::vector< int32_t > > input = ::genium::jni::convert_from_jni(_jenv,
...
{
    ::std::unordered_map< int32_t, ::std::unordered_map< int32_t, bool > > input = ::genium::jni::convert_from_jni(_jenv,
            ::genium::jni::make_non_releasing_ref(jinput),
...
{
    ::std::unordered_set< ::std::unordered_set< int32_t >, ::genium::hash< ::std::unordered_set< int32_t > > > input = ::genium::jni::convert_from_jni(_jenv,
            ::genium::jni::make_non_releasing_ref(jinput),
            (::std::unordered_set< ::std::unordered_set< int32_t >, ::genium::hash< ::std::unordered_set< int32_t > > >*)nullptr);
    auto pInstanceSharedPointer = reinterpret_cast<std::shared_ptr<::smoke::GenericTypesWithGenericTypes>*> (
        ::genium::jni::get_field_value(
            _jenv,
            ::genium::jni::make_non_releasing_ref(_jinstance),
...
{
    ::std::vector< ::std::unordered_map< int32_t, bool > > input = ::genium::jni::convert_from_jni(_jenv,
            ::genium::jni::make_non_releasing_ref(jinput),
...
{
    ::std::vector< ::std::unordered_set< int32_t > > input = ::genium::jni::convert_from_jni(_jenv,
            ::genium::jni::make_non_releasing_ref(jinput),
...
{
    ::std::unordered_map< int32_t, ::std::unordered_set< int32_t > > input = ::genium::jni::convert_from_jni(_jenv,
            ::genium::jni::make_non_releasing_ref(jinput),
...
{
    ::std::unordered_map< ::std::unordered_set< int32_t >, bool, ::genium::hash< ::std::unordered_set< int32_t > > > input = ::genium::jni::convert_from_jni(_jenv,
            ::genium::jni::make_non_releasing_ref(jinput),
            (::std::unordered_map< ::std::unordered_set< int32_t >, bool, ::genium::hash< ::std::unordered_set< int32_t > > >*)nullptr);
    auto pInstanceSharedPointer = reinterpret_cast<std::shared_ptr<::smoke::GenericTypesWithGenericTypes>*> (
        ::genium::jni::get_field_value(
            _jenv,
            ::genium::jni::make_non_releasing_ref(_jinstance),
