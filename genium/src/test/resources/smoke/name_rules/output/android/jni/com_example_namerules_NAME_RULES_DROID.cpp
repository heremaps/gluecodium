...
{
    ::namerules::NameRules::ExampleStruct some_argument = ::genium::jni::convert_from_jni(_jenv,
            ::genium::jni::make_non_releasing_ref(jsome_argument),
...
{
    ::namerules::NameRules::ExampleStruct value = ::genium::jni::convert_from_jni(_jenv,
