...
hash< ::smoke::EquatableStruct >::operator( )( const ::smoke::EquatableStruct& t ) const
{
    ...
    hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableStruct::bool_field ) >( )( t.bool_field ) ) << 1;
hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableStruct::int_field ) >( )( t.int_field ) ) << 1;
hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableStruct::long_field ) >( )( t.long_field ) ) << 1;
hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableStruct::float_field ) >( )( t.float_field ) ) << 1;
hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableStruct::double_field ) >( )( t.double_field ) ) << 1;
hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableStruct::string_field ) >( )( t.string_field ) ) << 1;
hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableStruct::struct_field ) >( )( t.struct_field ) ) << 1;
hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableStruct::enum_field ) >( )( t.enum_field ) ) << 1;
hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableStruct::array_field ) >( )( t.array_field ) ) << 1;
hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableStruct::map_field ) >( )( t.map_field ) ) << 1;
    return hash_value;
}
std::size_t
...
{
    size_t hash_value = 43;
    hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableNullableStruct::bool_field ) >( )( t.bool_field ) ) << 1;
hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableNullableStruct::int_field ) >( )( t.int_field ) ) << 1;
hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableNullableStruct::uint_field ) >( )( t.uint_field ) ) << 1;
hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableNullableStruct::float_field ) >( )( t.float_field ) ) << 1;
hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableNullableStruct::string_field ) >( )( t.string_field ) ) << 1;
hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableNullableStruct::struct_field ) >( )( t.struct_field ) ) << 1;
hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableNullableStruct::enum_field ) >( )( t.enum_field ) ) << 1;
hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableNullableStruct::array_field ) >( )( t.array_field ) ) << 1;
hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::EquatableNullableStruct::map_field ) >( )( t.map_field ) ) << 1;
    return hash_value;
}
std::size_t
...
{
    size_t hash_value = 43;
    hash_value = ( hash_value ^ ::genium::hash< decltype( ::smoke::NestedEquatableStruct::foo_field ) >( )( t.foo_field ) ) << 1;
    return hash_value;
}
}