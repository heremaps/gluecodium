...
bool smoke_MethodOverloads_isBoolean_stringOverload(_baseRef _instance, _baseRef input);
bool smoke_MethodOverloads_isBoolean_structOverload(_baseRef _instance, _baseRef input);
bool smoke_MethodOverloads_isBoolean_everythingOverload(_baseRef _instance, bool input1, int8_t input2, _baseRef input3, _baseRef input4);
...
bool smoke_MethodOverloads_isFloat_stringOverload(_baseRef _instance, _baseRef input);
