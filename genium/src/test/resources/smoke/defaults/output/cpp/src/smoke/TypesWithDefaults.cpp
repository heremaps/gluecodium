...
ImmutableStructWithDefaults::ImmutableStructWithDefaults( )
    : int_field( 42 ), uint_field{ }, float_field( 3.14f ), double_field( -1.4142 ), bool_field{ }, string_field( "\\Jonny \"Magic\" Smith\n" ), enum_field( ::smoke::SomeEnum::BAR_VALUE ), external_enum_field( ::fire::SomeVeryExternalEnum::Another_Value )
{
}
ImmutableStructWithDefaults::ImmutableStructWithDefaults( const uint32_t uint_field, const bool bool_field )
    : int_field( 42 ), uint_field( uint_field ), float_field( 3.14f ), double_field( -1.4142 ), bool_field( bool_field ), string_field( "\\Jonny \"Magic\" Smith\n" ), enum_field( ::smoke::SomeEnum::BAR_VALUE ), external_enum_field( ::fire::SomeVeryExternalEnum::Another_Value )
{
}
