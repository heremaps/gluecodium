...
#include <new>
_baseRef
smoke_StructWithInstances_StructWithInstances_create_handle( _baseRef classInstance, _baseRef interfaceInstance )
{
...
void
smoke_StructWithInstances_StructWithInstances_release_handle( _baseRef handle )
{
    delete get_pointer<::smoke::StructWithInstances>( handle );
}
_baseRef
smoke_StructWithInstances_StructWithInstances_create_optional_handle(_baseRef classInstance, _baseRef interfaceInstance)
{
...
_baseRef
smoke_StructWithInstances_StructWithInstances_unwrap_optional_handle( _baseRef handle )
{
    return reinterpret_cast<_baseRef>( &**reinterpret_cast<::genium::optional<::smoke::StructWithInstances>*>( handle ) );
}
void smoke_StructWithInstances_StructWithInstances_release_optional_handle(_baseRef handle) {
    delete reinterpret_cast<::genium::optional<::smoke::StructWithInstances>*>( handle );
}
_baseRef smoke_StructWithInstances_StructWithInstances_classInstance_get(_baseRef handle) {
...
_baseRef smoke_StructWithInstances_StructWithInstances_interfaceInstance_get(_baseRef handle) {
    auto struct_pointer = get_pointer<::smoke::StructWithInstances>(handle);
return Conversion<std::shared_ptr<::smoke::SimpleInterface>>::toBaseRef(struct_pointer->interface_instance);
}
_baseRef smoke_StructWithInstances_StructWithInstances_useSimpleClass(_baseRef _instance, _baseRef input) {
...
_baseRef smoke_StructWithInstances_StructWithInstances_useSimpleInterface(_baseRef _instance, _baseRef input) {
