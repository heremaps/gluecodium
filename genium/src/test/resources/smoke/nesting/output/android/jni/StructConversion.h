...
::smoke::NestedReferences::NestedReferences convert_from_jni(JNIEnv* _jenv, const JniReference<jobject>& _jinput, ::smoke::NestedReferences::NestedReferences* dummy);
::genium::optional<::smoke::NestedReferences::NestedReferences> convert_from_jni(JNIEnv* _jenv, const JniReference<jobject>& _jinput, ::genium::optional<::smoke::NestedReferences::NestedReferences>* dummy);
JniReference<jobject> convert_to_jni(JNIEnv* _jenv, const ::smoke::NestedReferences::NestedReferences& _ninput);
JniReference<jobject> convert_to_jni(JNIEnv* _jenv, const ::genium::optional<::smoke::NestedReferences::NestedReferences> _ninput);
