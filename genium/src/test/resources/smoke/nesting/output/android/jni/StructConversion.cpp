...
::gluecodium::optional<::smoke::FreePoint>
convert_from_jni(JNIEnv* _jenv, const JniReference<jobject>& _jinput, ::gluecodium::optional<::smoke::FreePoint>* dummy)
{
    return _jinput
        ? ::gluecodium::optional<::smoke::FreePoint>(convert_from_jni(_jenv, _jinput, (::smoke::FreePoint*)nullptr))
        : ::gluecodium::optional<::smoke::FreePoint>{};
}
...
JniReference<jobject>
convert_to_jni(JNIEnv* _jenv, const ::gluecodium::optional<::smoke::FreePoint> _ninput)
{
...
::gluecodium::optional<::smoke::NestedReferences::NestedReferences>
convert_from_jni(JNIEnv* _jenv, const JniReference<jobject>& _jinput, ::gluecodium::optional<::smoke::NestedReferences::NestedReferences>* dummy)
{
    return _jinput
        ? ::gluecodium::optional<::smoke::NestedReferences::NestedReferences>(convert_from_jni(_jenv, _jinput, (::smoke::NestedReferences::NestedReferences*)nullptr))
        : ::gluecodium::optional<::smoke::NestedReferences::NestedReferences>{};
}
...
JniReference<jobject>
convert_to_jni(JNIEnv* _jenv, const ::gluecodium::optional<::smoke::NestedReferences::NestedReferences> _ninput)
{
    return _ninput ? convert_to_jni(_jenv, *_ninput) : JniReference<jobject>{};
}
...
convert_from_jni(JNIEnv* _jenv, const JniReference<jobject>& _jinput, ::smoke::UnusedTopLevelPoint* dummy)
{
    ...
    ::std::string n_foo = ::gluecodium::jni::get_field_value(
        _jenv,
        _jinput,
        "foo",
        (::std::string*)nullptr );
...
::gluecodium::optional<::smoke::UnusedTopLevelPoint>
convert_from_jni(JNIEnv* _jenv, const JniReference<jobject>& _jinput, ::gluecodium::optional<::smoke::UnusedTopLevelPoint>* dummy)
{
    return _jinput
        ? ::gluecodium::optional<::smoke::UnusedTopLevelPoint>(convert_from_jni(_jenv, _jinput, (::smoke::UnusedTopLevelPoint*)nullptr))
        : ::gluecodium::optional<::smoke::UnusedTopLevelPoint>{};
}
...
convert_to_jni(JNIEnv* _jenv, const ::smoke::UnusedTopLevelPoint& _ninput)
{
    ...
    ::gluecodium::jni::set_field_value(_jenv, _jresult, "foo", jfoo);
    return _jresult;
}
JniReference<jobject>
convert_to_jni(JNIEnv* _jenv, const ::gluecodium::optional<::smoke::UnusedTopLevelPoint> _ninput)
{
    return _ninput ? convert_to_jni(_jenv, *_ninput) : JniReference<jobject>{};
}
}
