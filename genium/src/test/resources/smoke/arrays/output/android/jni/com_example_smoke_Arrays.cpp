...
{
    ::smoke::Arrays::StringArray input = genium::jni::convert_from_jni( _jenv, genium::jni::make_local_ref(_jenv, jinput), (::smoke::Arrays::StringArray*)nullptr );
...
{
    ::std::vector< uint8_t > input = genium::jni::convert_from_jni( _jenv, genium::jni::make_local_ref(_jenv, jinput), (::std::vector< uint8_t >*)nullptr );
...
{
    ::std::vector< ::smoke::Arrays::BasicStruct > input = genium::jni::convert_from_jni( _jenv, genium::jni::make_local_ref(_jenv, jinput), (::std::vector< ::smoke::Arrays::BasicStruct >*)nullptr );
...
{
    ::std::vector< ::alien::FooStruct > input = genium::jni::convert_from_jni( _jenv, genium::jni::make_local_ref(_jenv, jinput), (::std::vector< ::alien::FooStruct >*)nullptr );
...
{
    ::std::vector< ::smoke::Arrays::UIntArray > input = genium::jni::convert_from_jni( _jenv, genium::jni::make_local_ref(_jenv, jinput), (::std::vector< ::smoke::Arrays::UIntArray >*)nullptr );
...
{
    ::std::vector< ::smoke::Arrays::FancyStruct > inlineFancyArray = genium::jni::convert_from_jni( _jenv, genium::jni::make_local_ref(_jenv, jinlineFancyArray), (::std::vector< ::smoke::Arrays::FancyStruct >*)nullptr );
    ::smoke::Arrays::FancyArray fancyArray = genium::jni::convert_from_jni( _jenv, genium::jni::make_local_ref(_jenv, jfancyArray), (::smoke::Arrays::FancyArray*)nullptr );
...
{
    ::smoke::Arrays::ProfileIdList input = genium::jni::convert_from_jni( _jenv, genium::jni::make_local_ref(_jenv, jinput), (::smoke::Arrays::ProfileIdList*)nullptr );
...
{
    ::smoke::Arrays::ArrayOfMaps input = genium::jni::convert_from_jni( _jenv, genium::jni::make_local_ref(_jenv, jinput), (::smoke::Arrays::ArrayOfMaps*)nullptr );
...
{
    ::std::shared_ptr< ::std::vector< uint8_t > > input = genium::jni::convert_from_jni( _jenv, genium::jni::make_local_ref(_jenv, jinput), (::std::shared_ptr< ::std::vector< uint8_t > >*)nullptr );
...
{
    ::std::vector< ::smoke::Arrays::SomeEnum > input = genium::jni::convert_from_jni( _jenv, genium::jni::make_local_ref(_jenv, jinput), (::std::vector< ::smoke::Arrays::SomeEnum >*)nullptr );
...
{
    ::std::vector< ::alien::FooEnum > input = genium::jni::convert_from_jni( _jenv, genium::jni::make_local_ref(_jenv, jinput), (::std::vector< ::alien::FooEnum >*)nullptr );
