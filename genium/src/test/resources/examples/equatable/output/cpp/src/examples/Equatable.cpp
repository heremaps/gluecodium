...
hash< ::examples::EquatableStruct >::operator( )( const ::examples::EquatableStruct& t ) const
{
    ...
    hash_value = ( hash_value ^ ::gluecodium::hash< decltype( ::examples::EquatableStruct::int_field ) >( )( t.int_field ) ) << 1;
hash_value = ( hash_value ^ ::gluecodium::hash< decltype( ::examples::EquatableStruct::string_field ) >( )( t.string_field ) ) << 1;
hash_value = ( hash_value ^ ::gluecodium::hash< decltype( ::examples::EquatableStruct::struct_field ) >( )( t.struct_field ) ) << 1;
    return hash_value;
}
std::size_t
...
{
    size_t hash_value = 43;
    hash_value = ( hash_value ^ ::gluecodium::hash< decltype( ::examples::NestedEquatableStruct::foo_field ) >( )( t.foo_field ) ) << 1;
    return hash_value;
}
}