...
import Foundation
@_cdecl("_CBridgeInitexamples_DefaultValues")
internal func _CBridgeInitexamples_DefaultValues(handle: _baseRef) -> UnsafeMutableRawPointer {
...
internal func DefaultValuescopyFromCType(_ handle: _baseRef) -> DefaultValues {
    if let swift_pointer = examples_DefaultValues_get_typed(examples_DefaultValues_copy_handle(handle)),
...
internal func DefaultValuesmoveFromCType(_ handle: _baseRef) -> DefaultValues {
    if let swift_pointer = examples_DefaultValues_get_typed(handle),
        let typed = Unmanaged<AnyObject>.fromOpaque(swift_pointer).takeRetainedValue() as? DefaultValues {
        return typed
    }
    fatalError("Failed to initialize Swift object")
...
internal func copyFromCType(_ handle: _baseRef) -> DefaultValues.StructWithDefaults? {
    ...
    let unwrappedHandle = examples_DefaultValues_StructWithDefaults_unwrap_optional_handle(handle)
    return DefaultValues.StructWithDefaults(cHandle: unwrappedHandle) as DefaultValues.StructWithDefaults
}
internal func moveFromCType(_ handle: _baseRef) -> DefaultValues.StructWithDefaults? {
    defer {
        examples_DefaultValues_StructWithDefaults_release_optional_handle(handle)
    }
    return copyFromCType(handle)
}
internal func copyToCType(_ swiftType: DefaultValues.StructWithDefaults?) -> RefHolder {
