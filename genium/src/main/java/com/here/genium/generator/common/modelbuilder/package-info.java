 ...
 * <h1>Overview</h1>
 *
 * Generators use {@link com.here.ivi.api.generator.common.modelbuilder.ModelBuilder ModelBuilders}
 ...
 * com.here.ivi.api.generator.common.modelbuilder.FrancaTreeWalker}. Intermediate and final results
 * are stored in {@link com.here.ivi.api.generator.common.modelbuilder.ModelBuilderContext}.
 *
 * <h1>Rationale</h1>
 *
 * The bridging layers for {@link com.here.ivi.api.generator.jni.JniGenerator Java} and {@link
 * com.here.ivi.api.generator.cbridge.CBridgeGenerator Swift} code generation need to forward
 ...
 * com.here.ivi.api.generator.common.modelbuilder.ModelBuilderContext} from other generators that
 * are run in parallel. This way bridging generators can access the results of the other generators
 * to determine the types and names etc. for the conversion.
 */
