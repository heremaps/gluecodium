...
macro(apigen_set_generated_files _target)
  foreach(_source_group main common)
    ...
    set(APIGEN_GENERATED_cbridge_header_${_source_group}
        cbridge/${_target}_${_source_group}_cglue.h)
...
function(apigen_list_generated_sources _sources_list_output)
  ...
  foreach(_generator ${_generators})
    if(NOT _generator IN_LIST APIGEN_SUPPORTED_GENERATORS)
      message(
        FATAL_ERROR
          "Generator ${_generator} is not in list of supported generators: ${APIGEN_SUPPORTED_GENERATORS}"
      )
    endif()
  endforeach()
  ...
  foreach(_group ${_source_groups})
    list(
      APPEND _generated_files
             "${apigen_list_generated_sources_BUILD_OUTPUT_DIR}/${APIGEN_GENERATED_cpp_${_group}}")
    if(apigen_list_generated_sources_GENERATOR MATCHES android)
      list(
        APPEND _generated_files
               "${apigen_list_generated_sources_BUILD_OUTPUT_DIR}/${APIGEN_GENERATED_jni_${_group}}"
      )
    elseif(apigen_list_generated_sources_GENERATOR MATCHES swift)
      list(
        APPEND
          _generated_files
          "${apigen_list_generated_sources_BUILD_OUTPUT_DIR}/${APIGEN_GENERATED_cbridge_${_group}}")
      list(
        APPEND
          _generated_files
          "${apigen_list_generated_sources_BUILD_OUTPUT_DIR}/${APIGEN_GENERATED_cbridge_header_${_group}}"
      )
      list(
        APPEND
          _generated_files
          "${apigen_list_generated_sources_BUILD_OUTPUT_DIR}/${APIGEN_GENERATED_swift_${_group}}")
    endif()
    ...
    if(apigen_list_generated_sources_GENERATOR MATCHES dart)
      list(
        APPEND
          _generated_files
          "${apigen_list_generated_sources_BUILD_OUTPUT_DIR}/${APIGEN_GENERATED_dart_${_group}}")
    endif()
  endforeach()
