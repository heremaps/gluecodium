...
set(_required_vars GLUECODIUM_DETAILS_DIR APIGEN_JAVA_LOCAL_SOURCES_DIRS
...
execute_process(
  ...
  COMMAND
    ${GLUECODIUM_GRADLE_WRAPPER} -b=compileJava.gradle -PsrcDirs=${APIGEN_JAVA_LOCAL_SOURCES_DIRS}
