...
macro(apigen_set_generated_files target)
  foreach(_source_group main common)
    set(APIGEN_GENERATED_cpp_${_source_group} cpp/${target}_${_source_group}_glue.cpp)
    set(APIGEN_GENERATED_jni_${_source_group} android/${target}_${_source_group}_jniglue.cpp)
    set(APIGEN_GENERATED_cbridge_${_source_group} cbridge/${target}_${_source_group}_cglue.cpp)
    set(APIGEN_GENERATED_cbridge_header_${_source_group} cbridge/${target}_${_source_group}_cglue.h)
    set(APIGEN_GENERATED_swift_${_source_group} swift/${target}_${_source_group}_glue.swift)
    set(APIGEN_GENERATED_dart_${_source_group} dart/${target}_${_source_group}_ffiglue.cpp)
  endforeach()
