...
function(apigen_java_compile target)
    ...
    if(${GENERATOR} MATCHES android)
        ...
        set(APIGEN_TRANSPILER_JAVA_SOURCE_DIR ${OUTPUT_DIR}/com/here/android)
        ...
        add_custom_command(TARGET ${target} POST_BUILD
            ...
            COMMAND find ${TRANSPILER_ANDROID_DIR} -name *.java | xargs "${Java_JAVAC_EXECUTABLE}" ${CMAKE_JAVA_COMPILE_FLAGS} -d ${APIGEN_JAVA_COMPILE_OUTPUT_DIR}
