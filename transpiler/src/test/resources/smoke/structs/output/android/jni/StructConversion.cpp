...
void convert_from_jni( JNIEnv* _jenv, const jobject _jinput, ::smoke::Structs::Point& _nout ){
  ...
  _nout.x = here::internal::get_double_field(_jenv, javaClass, _jinput, "x");
  _nout.y = here::internal::get_double_field(_jenv, javaClass, _jinput, "y");
}
...
void convert_from_jni( JNIEnv* _jenv, const jobject _jinput, ::smoke::Structs::Color& _nout ){
  jclass javaClass = _jenv->GetObjectClass(_jinput);
  _nout.red = here::internal::get_long_field(_jenv, javaClass, _jinput, "red");
  _nout.green = here::internal::get_long_field(_jenv, javaClass, _jinput, "green");
  _nout.blue = here::internal::get_long_field(_jenv, javaClass, _jinput, "blue");
}
jobject convert_to_jni(JNIEnv* _jenv, const ::smoke::Structs::Color& _ninput){
  ...
  here::internal::set_long_field(_jenv, javaClass, _jresult, "red", jred);
...
jobject convert_to_jni(JNIEnv* _jenv, const ::smoke::Structs::Line& _ninput){
  ...
  here::internal::set_object_field(_jenv, javaClass, _jresult, "a",
...
jobject convert_to_jni(JNIEnv* _jenv, const ::smoke::Structs::ColoredLine& _ninput){
  ...
  here::internal::set_object_field(_jenv, javaClass, _jresult, "line",
...
void convert_from_jni( JNIEnv* _jenv, const jobject _jinput, ::smoke::Structs::AllTypesStruct& _nout ){
  jclass javaClass = _jenv->GetObjectClass(_jinput);
  _nout.int8_field = here::internal::get_byte_field(_jenv, javaClass, _jinput, "int8Field");
  _nout.uint8_field = here::internal::get_long_field(_jenv, javaClass, _jinput, "uint8Field");
  _nout.int16_field = here::internal::get_short_field(_jenv, javaClass, _jinput, "int16Field");
  _nout.uint16_field = here::internal::get_long_field(_jenv, javaClass, _jinput, "uint16Field");
  _nout.int32_field = here::internal::get_int_field(_jenv, javaClass, _jinput, "int32Field");
  _nout.uint32_field = here::internal::get_long_field(_jenv, javaClass, _jinput, "uint32Field");
  _nout.int64_field = here::internal::get_long_field(_jenv, javaClass, _jinput, "int64Field");
  _nout.uint64_field = here::internal::get_long_field(_jenv, javaClass, _jinput, "uint64Field");
  _nout.float_field = here::internal::get_float_field(_jenv, javaClass, _jinput, "floatField");
  _nout.double_field = here::internal::get_double_field(_jenv, javaClass, _jinput, "doubleField");
  _nout.string_field = here::internal::get_string_field(_jenv, javaClass, _jinput, "stringField");
  _nout.boolean_field = here::internal::get_boolean_field(_jenv, javaClass, _jinput, "booleanField");
  _nout.bytes_field = here::internal::get_byte_array_field(_jenv, javaClass, _jinput, "bytesField");
  convert_from_jni(
    _jenv,
    here::internal::get_object_field(
    _jenv,
...
jobject convert_to_jni(JNIEnv* _jenv, const ::smoke::Structs::AllTypesStruct& _ninput){
  ...
  here::internal::set_byte_field(_jenv, javaClass, _jresult, "int8Field", jint8_field);
  auto juint8_field = _ninput.uint8_field;
  here::internal::set_long_field(_jenv, javaClass, _jresult, "uint8Field", juint8_field);
  auto jint16_field = _ninput.int16_field;
  here::internal::set_short_field(_jenv, javaClass, _jresult, "int16Field", jint16_field);
  auto juint16_field = _ninput.uint16_field;
  here::internal::set_long_field(_jenv, javaClass, _jresult, "uint16Field", juint16_field);
  auto jint32_field = _ninput.int32_field;
  here::internal::set_int_field(_jenv, javaClass, _jresult, "int32Field", jint32_field);
  auto juint32_field = _ninput.uint32_field;
  here::internal::set_long_field(_jenv, javaClass, _jresult, "uint32Field", juint32_field);
  auto jint64_field = _ninput.int64_field;
  here::internal::set_long_field(_jenv, javaClass, _jresult, "int64Field", jint64_field);
  auto juint64_field = _ninput.uint64_field;
  here::internal::set_long_field(_jenv, javaClass, _jresult, "uint64Field", juint64_field);
  auto jfloat_field = _ninput.float_field;
  here::internal::set_float_field(_jenv, javaClass, _jresult, "floatField", jfloat_field);
  auto jdouble_field = _ninput.double_field;
  here::internal::set_double_field(_jenv, javaClass, _jresult, "doubleField", jdouble_field);
  auto jstring_field = _ninput.string_field;
  here::internal::set_string_field(_jenv, javaClass, _jresult, "stringField", jstring_field);
  auto jboolean_field = _ninput.boolean_field;
  here::internal::set_boolean_field(_jenv, javaClass, _jresult, "booleanField", jboolean_field);
  auto jbytes_field = _ninput.bytes_field;
  here::internal::set_byte_array_field(_jenv, javaClass, _jresult, "bytesField", jbytes_field);
...
void convert_from_jni( JNIEnv* _jenv, const jobject _jinput, ::smoke::GrandChildStruct& _nout ){
  jclass javaClass = _jenv->GetObjectClass(_jinput);
  _nout.parent_field = here::internal::get_float_field(_jenv, javaClass, _jinput, "parentField");
  _nout.child_field = here::internal::get_int_field(_jenv, javaClass, _jinput, "childField");
  _nout.grand_child_field = here::internal::get_string_field(_jenv, javaClass, _jinput, "grandChildField");
}
...
jobject convert_to_jni(JNIEnv* _jenv, const ::fire::StructsQualifiedType::QualifiedType& _ninput){
  ...
  here::internal::set_object_field(_jenv, javaClass, _jresult, "typeCollectionPoint",
  ...
  here::internal::set_object_field(_jenv, javaClass, _jresult, "interfacePoint",
  ...
  here::internal::set_object_field(_jenv, javaClass, _jresult, "typeCollectionExplicitPoints",
  ...
  here::internal::set_object_field(_jenv, javaClass, _jresult, "interfaceExplicitPoints",
  ...
  here::internal::set_object_field(_jenv, javaClass, _jresult, "typeCollectionImplicitPoints",
  ...
  here::internal::set_object_field(_jenv, javaClass, _jresult, "interfaceImplicitPoints",
