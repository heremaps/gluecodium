  ...
  public void generate() {
    ...
    assertEquals(
        "\n"
            ...
            + "\n"
            + "CppClassCppProxy::CppClassCppProxy( JNIEnv* _jenv, jobject _jobj ) : CppProxyBase"
            + "(_jenv, _jobj) {\n"
            + "}\n"
            + "\n"
            + "void CppClassCppProxy::cppMethod( const int32_t paramint_1, const int32_t "
            + "paramint_2 ) {\n"
            + "    jmethodID _jmethodId = _jEnvironment->GetMethodID(_jClass, \"\", \"(II)V\");\n"
            + "    callJavaMethod( _jmethodId , paramint_1, paramint_2);\n"
            + "}\n"
            + "void CppClassCppProxy::cppMethod( const double paramdouble_1, const double "
            + "paramdouble_2 ) const {\n"
            + "    jmethodID _jmethodId = _jEnvironment->GetMethodID(_jClass, \"\", \"(DD)V\");\n"
            + "    callJavaMethod( _jmethodId , paramdouble_1, paramdouble_2);\n"
            + "}\n"
            + "\n"
            + "}\n"
            + "}\n",
