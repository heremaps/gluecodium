...
public final class CppCommentHeaderTemplateTest {
  ...
  public void nullGeneratorNotice() {
    String result = CppCommentHeaderTemplate.generate(null);
  ...
  public void emptyGeneratorNotice() {
    String result = CppCommentHeaderTemplate.generate("");
  ...
  public void someGeneratorNotice() {
    ...
    String result = CppCommentHeaderTemplate.generate(generatorNotice);
