  ...
  public void generate() {
    ...
    assertEquals(
        TEST_COPYRIGHT_HEADER
            ...
            + "\n"
            + "\n"
            + "class CppClassCppProxy : private here::internal::CppProxyBase, public CppClass {\n"
            + "\n"
            + "public:\n"
            + "\n"
            + "    CppClassCppProxy( JNIEnv* _jenv, jobject _jobj );\n"
            + "\n"
            + "    void cppMethod( const int32_t paramint_1, const int32_t paramint_2 ) override;\n"
            + "\n"
            + "    void cppMethod( const double paramdouble_1, const double paramdouble_2 ) const"
            + " override;\n"
            + "\n"
            + "};\n"
            + "\n"
